    ...
    public class Lumberjacking : HarvestSystem
    {
        ...
        private Lumberjacking()
        {
            ...
            if (Core.ML)
            {
                ...
                {
                    new HarvestVein( 14.0, 0.0, res[0], null ), // this line should replace the original line
					...
					new HarvestVein( 04.0, 0.5, res[9], res[0] ), 	// PurpleHeartLog
					new HarvestVein( 04.0, 0.5, res[10], res[0] ),	// RedwoodLog
					new HarvestVein( 04.0, 0.5, res[11], res[0] ),	// PetrifiedLog
                };
				//daat99
