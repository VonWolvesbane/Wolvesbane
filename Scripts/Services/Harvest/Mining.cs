    ...
    public class Mining : HarvestSystem
    {
        ...
        private Mining()
        {
            ...
            veins = new HarvestVein[]
            {
				...
				new HarvestVein( 07.5, 0.5, res[4], res[0] ), // Bronze
				new HarvestVein( 07.0, 0.5, res[5], res[0] ), // Gold
				new HarvestVein( 07.0, 0.5, res[6], res[0] ), // Agapite
				new HarvestVein( 06.5, 0.5, res[7], res[0] ), // Verite
				new HarvestVein( 06.5, 0.5, res[8], res[0] ),  // Valorite
				new HarvestVein( 06.0, 0.5, res[9], res[0] ), // Blaze
            ...
            if (Core.ML)
            {
                ...
                {
                    new BonusHarvestResource(0, 99.0, null, null), //Nothing
