...
namespace Server.Engines.BulkOrders
{
    public class LargeBulkEntry
    {
        ...
        public static SmallBulkEntry[] Bow
        {
            get 
			{ 
				return GetEntries("Fletcher", "bows"); 
			}
        }
        public static SmallBulkEntry[] CrossBow
        {
            get 
			{ 
				return GetEntries("Fletcher", "crossbows"); 
			}
        }
		// Carpenter
		...
		public static SmallBulkEntry[] AllCarpentry
		{
			get{ return GetEntries("Carpenter", "allcarpentry"); }
		}
