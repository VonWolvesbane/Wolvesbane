...
namespace Server.Engines.BulkOrders
{
    public class SmallBulkEntry
    {
        ...
        public static SmallBulkEntry[] CarpenterAllCarpentry
        {
            get 
			{ 
				return GetEntries("Carpenter", "allcarpentry"); 
			}
        }
        ...
        public static SmallBulkEntry[] CarpenterArmory
        {
            get 
			{ 
				return GetEntries("Carpenter", "armory"); 
			}
        }
        ...
        public static SmallBulkEntry[] CarpenterInstrument
        {
            get 
			{ 
				return GetEntries("Carpenter", "instrument"); 
			}
        }
