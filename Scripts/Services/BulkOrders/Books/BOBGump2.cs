	...
	public class BOBGump2 : Gump
	{
		...
		public bool CheckFilter( BulkMaterialType mat, int amountMax, bool isLarge, bool reqExc, BODType deedType, Type itemType )
		{
			...
			switch ( f.Material )
			{
                ...
                case 3: return (mat == BulkMaterialType.None && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Wood);
                ...
                case 15: return (mat == BulkMaterialType.None && BGTClassifier.Classify(deedType, itemType) == BulkGenericType.Wood);
		...
		public object GetMaterialName( BulkMaterialType mat, BODType type, Type itemType )
		{
			switch ( type )
			{
                case BODType.Carpenter:
                {
                    switch (mat)
                    {
                        case BulkMaterialType.None: return "RegularWood";
		...
		public BOBGump2( PlayerMobile from, BulkOrderBook2 book ) : this( from, book, 0, null )
		{
		}
		...
		private class SetPricePrompt : Prompt
		{
			...
			public SetPricePrompt( BulkOrderBook2 book, object obj, int page, ArrayList list )
			{
				m_Book = book;
				m_Object = obj;
				m_Page = page;
			...
			public override void OnResponse( Mobile from, string text )
			{
				...
				else if ( m_Object == null )
				{
					...
					if ( from is PlayerMobile )
						from.SendGump( new BOBGump2( (PlayerMobile)from, m_Book, m_Page, m_List ) );
				}
		...
		public BOBGump2( PlayerMobile from, BulkOrderBook2 book, int page, ArrayList list ) : base( 12, 24 )
		{
