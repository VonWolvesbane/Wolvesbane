...
namespace Server.Engines.CannedEvil
{
	public class ChampionSystem
	{
		...
		//Daat99
		private static int m_TokenShowerPiles;
		private static int m_TokenShowerMinAmount;
		private static int m_TokenShowerMaxAmount;
		private static int m_HarrowerTokenPiles;
		private static int m_HarrowerTokenMinAmount;
		private static int m_HarrowerTokenMaxAmount;
		//End
		...
		//Daat99
		public static int TokenShowerPiles { get { return m_TokenShowerPiles; } }
		public static int TokenShowerMinAmount { get { return m_TokenShowerMinAmount; } }
		public static int TokenShowerMaxAmount { get { return m_TokenShowerMaxAmount; } }
		public static int HarrowerTokenShowerPiles { get { return m_HarrowerTokenPiles; } }
		public static int HarrowerTokenShowerMinAmount { get { return m_HarrowerTokenMinAmount; } }
		public static int HarrowerTokenShowerMaxAmount { get { return m_HarrowerTokenMaxAmount; } }
		//End
		...
		public static void Configure()
		{
			...
			//Daat99
			m_TokenShowerPiles = Config.Get("Champions.TokenPiles", 50);
			m_TokenShowerMinAmount = Config.Get("Champions.TokenMin", 4000);
			m_TokenShowerMaxAmount = Config.Get("Champions.TokenMax", 5500);
			m_HarrowerTokenPiles = Config.Get("Champions.HarrowerTokenPiles", 75);
			m_HarrowerTokenMinAmount = Config.Get("Champions.HarrowerTokenMin", 5000);
			m_HarrowerTokenMaxAmount = Config.Get("Champions.HarrowerTokenMax", 10000);
			//End
			...
			m_HarrowerGoldPiles = Config.Get("Champions.HarrowerGoldPiles", 95);
			...
			m_PowerScrollAmount = Config.Get("Champions.PowerScrolls", 4);
			m_StatScrollAmount = Config.Get("Champions.StatScrolls", 1);
			...
			m_MaxKill[2] = Config.Get("Champions.Rank3MaxKills", 128);
			m_MaxKill[3] = Config.Get("Champions.Rank4MaxKills", 92);
