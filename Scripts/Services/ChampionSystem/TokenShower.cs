...
{
	public class TokenShower
	{
		public static void DoForChamp(Point3D center, Map map)
		{
			Do(center, map, ChampionSystem.TokenShowerPiles, ChampionSystem.TokenShowerMinAmount, ChampionSystem.TokenShowerMaxAmount);
		}
		public static void DoForHarrower(Point3D center, Map map)
		{
			Do(center, map, ChampionSystem.HarrowerTokenShowerPiles, ChampionSystem.HarrowerTokenShowerMinAmount, ChampionSystem.HarrowerTokenShowerMaxAmount);
		}
		...
		private class GoodiesTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				Point3D p = FindTokenLocation(m_Map, m_Location, m_PilesMax / 8);
			...
			private static Point3D FindTokenLocation(Map map, Point3D center, int range)
			{
				int cx = center.X;
				int cy = center.Y;
