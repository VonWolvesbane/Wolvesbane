...
namespace Server.Engines.CannedEvil
{
    ...
    public class ChampionSpawnInfo
    {
        ...
        private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
        {
			...
			//Custom Champion Keeper of Knowledge
			new ChampionSpawnInfo( "The Keeper of Advanced Knowledge", typeof(TKOAK), new string[]{ "Smart", "Brilliant", "Clever" } , new Type[][]
			{																											// The Keeper
				new Type[]{ typeof( Kitten ), typeof( WolfPup ) },														// Level 1
