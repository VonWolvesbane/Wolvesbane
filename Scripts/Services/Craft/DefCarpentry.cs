    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
           ...
           AddRes(index, typeof(Cloth), 1044286, 60, 1044287);
            ...
            AddCraft(typeof(GoldFishPole), "Tools", "Aquarium Tools", 75.0, 110.0, typeof(Board), 1044041, 7, 1044351);
            ...
            AddSubRes(typeof(OakBoard), 1072644, 50.0, 1044041, 1072652);
            AddSubRes(typeof(AshBoard), 1072645, 55.0, 1044041, 1072652);
            AddSubRes(typeof(YewBoard), 1072646, 60.0, 1044041, 1072652);
            AddSubRes(typeof(HeartwoodBoard), 1072647, 65.0, 1044041, 1072652);
            AddSubRes(typeof(BloodwoodBoard), 1072648, 70.0, 1044041, 1072652);
            AddSubRes(typeof(FrostwoodBoard), 1072649, 75.0, 1044041, 1072652);
            AddSubRes(typeof(EbonyBoard), "Ebony", 85.0, 1072652);
            AddSubRes(typeof(BambooBoard), "Bamboo", 95.0, 1072652);
            AddSubRes(typeof(PurpleHeartBoard), "Purple Heart", 105.0, 1072652);
            AddSubRes(typeof(RedwoodBoard), "Redwood", 115.0, 1072652);
            AddSubRes(typeof(PetrifiedBoard), "Petrified", 119.0, 1072652);
