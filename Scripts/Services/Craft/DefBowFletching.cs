...
namespace Server.Engines.Craft
{
    ...
    public class DefBowFletching : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            this.AddCraft(typeof(BowOfEvolution), "Evo Bows", "Bow of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
            this.AddCraft(typeof(CrossbowOfEvolution), "Evo Bows", "Crossbow Of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
            this.AddCraft(typeof(HeavyCrossbowOfEvolution), "Evo Bows", "Heavy Crossbow of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
            this.AddCraft(typeof(CompositeBowOfEvolution), "Evo Bows", "Composite Bow of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
            this.AddCraft(typeof(ElvenCompositeLongbowOfEvolution), "Evo Bows", "Elven Composite Longbow Of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
            this.AddCraft(typeof(RepeatingCrossbowOfEvolution), "Evo Bows", "Repeating Crossbow of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
            this.AddCraft(typeof(YumiOfEvolution), "Evo Bows", "Yumi of Evolution", 100.0, 120.0, typeof(PetrifiedBoard), "Petrified Boards", 250, 1044351);
