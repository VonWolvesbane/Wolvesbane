...
namespace Server.Engines.Craft
{
    ...
    public class DefTinkering : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            //Master Keys
            //index = AddCraft(typeof(MasterItemStoreKey), "Customs", "Master Keys", 120.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            //AddSkill(index, SkillName.Carpentry, 120.0, 150.0);
           // AddSkill(index, SkillName.Blacksmith, 120.0, 150.0);
           // AddSkill(index, SkillName.Tailoring, 120.0, 150.0);
          //  AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 200, "You need more Platinum Ingots");
          //  AddRes(index, typeof(SpinedLeather), "Spined Leather", 200, "You need more Spined Leather");
           // AddRes(index, typeof(PetrifiedBoard), "Petrified Boards", 50, "You need more Petrified Boards");

            //AddOn Key
            index = AddCraft(typeof(AddonDeedKey), "Customs", "AddOn Deed Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.Blacksmith, 110.0, 150.0);
            AddSkill(index, SkillName.Tailoring, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            AddRes(index, typeof(SpinedLeather), "Spined Leather", 100, "You need more Spined Leather");
            AddRes(index, typeof(PetrifiedBoard), "Petrified Boards", 20, "You need more Petrified Boards");

            // Adventurer Key
            index = AddCraft(typeof(AdventurerKey), "Customs", "Adventurer's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            ...
            // Armor Key
            index = AddCraft(typeof(ArmorKey), "Customs", "Armor Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Armory Key
            index = AddCraft(typeof(ArmoryKey), "Customs", "Armory Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // ASH Key
            index = AddCraft(typeof(ASHKey), "Customs", "ASH Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Bard Key
            index = AddCraft(typeof(BardsKey), "Customs", "Bard's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Beverage Key
            index = AddCraft(typeof(BeverageKey), "Customs", "Beverage Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // BOD Key
            index = AddCraft(typeof(BODKey), "Customs", "BOD Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Champ Skull Key
            index = AddCraft(typeof(ChampSkullKey), "Customs", "Champ Skull Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Chef Key
            index = AddCraft(typeof(ChefKey), "Customs", "Chef Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Clothing Key
            index = AddCraft(typeof(ClothingKey), "Customs", "Clothing Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Fish Key
            index = AddCraft(typeof(FishKey), "Customs", "Fish Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Gardeners Key
            index = AddCraft(typeof(GardenersKey), "Customs", "Gardener's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Gem Key
            index = AddCraft(typeof(GemKey), "Customs", "Gem Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Granite Key
            index = AddCraft(typeof(GraniteKey), "Customs", "Granite Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Jewelers Key
            index = AddCraft(typeof(JewelersKey), "Customs", "Jeweler's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Jewelry Key
            index = AddCraft(typeof(JewelryKey), "Customs", "Jewelry Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Meat Key
            index = AddCraft(typeof(MeatKey), "Customs", "Meat Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Potion Key
            index = AddCraft(typeof(PotionKey), "Customs", "Potion Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // PS Key
            index = AddCraft(typeof(PSKey), "Customs", "PS Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Reagent Key
            index = AddCraft(typeof(ReagentKey), "Customs", "Reagent Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Runic Tool Key
            index = AddCraft(typeof(RunicToolKey), "Customs", "Runic Tool Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Scribe's Key
            index = AddCraft(typeof(ScribesKey), "Customs", "Scribe's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Smithy Key
            index = AddCraft(typeof(SmithyKey), "Customs", "Smithy Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Tailor's Key
            index = AddCraft(typeof(TailorKey), "Customs", "Tailor's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Tool Key
            index = AddCraft(typeof(ToolKey), "Customs", "Tool Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Treasure Hunter's Key
            index = AddCraft(typeof(TreasureHuntersKey), "Customs", "Treasure Hunter's Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Weapon Key
            index = AddCraft(typeof(WeaponKey), "Customs", "Weapon Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            // Wood Key
            index = AddCraft(typeof(WoodKey), "Customs", "Wood Key", 110.0, 150.0, typeof(KeyRing), "KeyRing", 2, "You need more Key Rings");
            AddSkill(index, SkillName.Alchemy, 110.0, 150.0);
            AddSkill(index, SkillName.Carpentry, 110.0, 150.0);
            AddSkill(index, SkillName.ItemID, 110.0, 150.0);
            AddRes(index, typeof(PlatinumIngot), "Platinum Ingots", 100, "You need more Platinum Ingots");
            ...
            AddSubRes(typeof(ShadowIronIngot), 1044024, 55.0, 1044036, 1044268);
            AddSubRes(typeof(CopperIngot), 1044025, 65.0, 1044036, 1044268);
            AddSubRes(typeof(BronzeIngot), 1044026, 75.0, 1044036, 1044268);
            AddSubRes(typeof(GoldIngot), 1044027, 80.0, 1044036, 1044268);
            AddSubRes(typeof(AgapiteIngot), 1044028, 85.0, 1044036, 1044268);
            AddSubRes(typeof(VeriteIngot), 1044029, 90.0, 1044036, 1044268);
