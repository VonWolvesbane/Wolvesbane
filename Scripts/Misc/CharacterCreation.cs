...
namespace Server.Misc
{
	...
	{
		private static readonly CityInfo m_CityofWolvesbaneInfo = new CityInfo(
			"City of Wolvesbane",
			"Town Center",
            5640,
            953,
		...
		private static void AddBackpack(Mobile m)
		{
			...
			PackItem(new BankCheck(50000)); // Starting gold can be customized here
			///PackItem(new Candle());
			PackItem(new daat99.MasterStorage());
            PackItem(new Trash4TokensBackpack());
            //PackItem(new SkillBall700());
