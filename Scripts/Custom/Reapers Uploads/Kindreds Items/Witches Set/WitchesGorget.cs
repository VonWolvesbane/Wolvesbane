...
{
	public class WitchesGorget: LeatherGorget
	{
...
public override bool IsArtifact { get { return true; } }
		...
		[Constructable]
		public WitchesGorget()
		{

			//this.SkillBonuses.SetValues(0, SkillName.Archery, 10);

			Hue = 2342; 
            Name = "<Body bgcolor=Black; text=#9400D3><Big><center>Witches Gorget</Body>";
		...
		public WitchesGorget( Serial serial ) : base( serial )
		{
		}
