...
{
    public class ArtifactEarring : GoldEarrings
	{
        ...
        public ArtifactEarring()
        {
            ...
            Resistances.Physical = Utility.RandomMinMax(0, 25);
            Resistances.Fire = Utility.RandomMinMax(0, 25);
            Resistances.Cold = Utility.RandomMinMax(0, 25);
            Resistances.Poison = Utility.RandomMinMax(0, 25);
            Resistances.Energy = Utility.RandomMinMax(0, 25);
          
            // id it shows item as
            switch (Utility.Random(2))
            {
                case 0: ItemID = 4231; break;// gold
                case 1: ItemID = 7943; break;// silver
...
// END random skill bonus
     //Disadvantages
	 	...
	 	public ArtifactEarring(Serial serial) : base( serial )
	 	{
	 	}
