...
{
    public class ArtifactRing : GoldRing
	{
        ...
        public ArtifactRing()
        {
          ...
          Resistances.Energy = Utility.RandomMinMax(0, 15);
            ...
            {
                case 0: ItemID = 4234; break;//gold
                case 1: ItemID = 7945; break;// silver
...
// END random skill bonus
     //Disadvantages
	 	...
	 	public ArtifactRing(Serial serial) : base( serial )
	 	{
	 	}
