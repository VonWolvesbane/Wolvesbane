...
{
    public class ArtifactArm : LeatherArms
	{
         ...
         private static string[] m_Names = new string[]
		{
	 	...
	 	public ArtifactArm()
	 	{
			 ...
			 switch (Utility.Random(5))
            {
                ...
                case 1: ItemID = 9815; break;//Dragon
                case 2: ItemID = 5084; break;//Studded
                case 3: ItemID = 5069; break;//leather
                case 4: ItemID = 5136; break;//plate
            }
