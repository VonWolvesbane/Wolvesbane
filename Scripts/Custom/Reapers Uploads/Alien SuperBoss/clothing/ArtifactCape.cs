...
{
    public class ArtifactCape : FurCape
	{
        ...
        public ArtifactCape()
        {
            ...
            */
            ...
            {
                case 0: ItemID = 8970; break;// furCape
                case 1: ItemID = 5397; break;// cloak
...
// END random skill bonus
     //Disadvantages
	 	...
	 	public ArtifactCape(Serial serial) : base( serial )
	 	{
	 	}
