...
{
    [CorpseName("remains of a kitten")]

    public class Kitten : BaseCreature
    {
        
        [Constructable]

        public Kitten() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a kitten";
            Hue = 2066;
            Body = 0xC9;
        ...
        public Kitten(Serial serial) : base(serial)
        {
        }
