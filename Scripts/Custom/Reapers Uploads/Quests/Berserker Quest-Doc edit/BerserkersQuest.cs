...
{[CorpseName( "Ike's Corpse" )]public class Ike : Mobile{public virtual bool IsInvulnerable{ get{ return true; } }
[Constructable]public Ike(){
...
public class IkeEntry : ContextMenuEntry{private Mobile m_Mobile;private Mobile m_Giver;
...
mobile.AddToBackpack(new SkullBucket( ));
///////////gump name
...
///////////item to be dropped
if( dropped is FullSkullBucket ){if(dropped.Amount!=1)
{this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "You need more skulls!", mobile.NetState );return false;}
dropped.Delete();
