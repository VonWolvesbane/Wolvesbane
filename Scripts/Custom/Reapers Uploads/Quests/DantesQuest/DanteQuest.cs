...
{[CorpseName( "Dante's Corpse" )]public class Dante : Mobile{public virtual bool IsInvulnerable{ get{ return true; } }
[Constructable]public Dante(){
...
public class DanteEntry : ContextMenuEntry{private Mobile m_Mobile;private Mobile m_Giver;
...
// item to be dropped
if( dropped is DantesInks ){if(dropped.Amount!=5)
