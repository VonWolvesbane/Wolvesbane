...
"<BASEFONT COLOR=White>The Thieving Serpentine is located west of Spirituality shrine Trammel. You will find 2 fishing holes where the Golden Fish was stolen from me. The Serpentine should be close to there.<br><br>" +
"</BODY>", false, true);
