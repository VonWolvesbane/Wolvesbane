...
namespace Server.Items
{
	public class HellSword : ThinLongsword  // your name of weapon(no spaces) : name of the base weapon you want to use. ie:Katana (make sure you capitalize both names)
	{
		...
		public override int InitMinHits{ get{ return 225; } } // Set the minium amount of hit points for the weapon.
		public override int InitMaxHits{ get{ return 225; } } // Set the Maxium amount of hit points for the weapon.
