...
{ public class TedGump : Gump { 
public static void Initialize() { 
CommandSystem.Register( "TedGump", AccessLevel.GameMaster, new CommandEventHandler( TedGump_OnCommand ) ); 
}
private static void TedGump_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new TedGump( e.Mobile ) ); } 
public TedGump( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
...
"<BASEFONT COLOR=YELLOW>time machine with my best friend Bill.<BR>" +
"<BASEFONT COLOR=YELLOW>Oh and by the way my name's Ted. Sweet<BR>" +
...
"<BASEFONT COLOR=YELLOW>bring each of them to me and Bill, that<BR>" +
"<BASEFONT COLOR=YELLOW>would be So Excelent dude! Remeber that<BR>" +
"<BASEFONT COLOR=YELLOW>the keys are located on 1 Arcane Demon<BR>" +
"<BASEFONT COLOR=YELLOW>And 1 on the ReaperGuy, near fel Despise<BR>" +
