...
"<BASEFONT COLOR=YELLOW>Use the gate beside me.<BR>" +
...
"<BASEFONT COLOR=YELLOW><BR>" +
"<BASEFONT COLOR=YELLOW>Fifth, you must clean the dungeon <BR>" +
"<BASEFONT COLOR=YELLOW>and collect some dung.<BR>" +
"<BASEFONT COLOR=YELLOW><BR>" +
