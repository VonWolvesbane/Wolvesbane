...
//----------------------/----------------------------------------------/
"<BASEFONT COLOR=GREEN>Please! can you get me some easter eggs!<BR><BR>" + 
"<BASEFONT COLOR=GREEN>I didn't receive any today and its Easter Day!<BR><BR>" +
"<BASEFONT COLOR=GREEN>Please bring me Easter Eggs and in return<BR><BR>" +
...
//--------------------------------------------------------------------------------------------------------------
      ...
      { 
         ...
         { 
            ...
            { 
               //Cancel 
               from.SendMessage( "Please hurry back" );
               break; 
            } 
