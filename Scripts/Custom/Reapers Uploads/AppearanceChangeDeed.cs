...
namespace Server.Items
{
    ...
    public class AppearanceChangeDeed : Item
    {
        private bool m_Redyable;

        [Constructable]
        public AppearanceChangeDeed()
            : base(0x14f0)
        {
            Weight = 0.0;
            Hue = 1709;
            Name = "Appearance Change Deed"; //?????
            m_Redyable = false;
            LootType = LootType.Blessed;
        }

        public AppearanceChangeDeed(Serial serial)
            : base(serial)
        {
        }
    ...
    public class ACGUMP2 : Gump
    {
        ...
        public int m_cost;
        public int m;
        private AppearanceChangeDeed m_deed;  // Vii edit

        public ACGUMP2(AppearanceChangeDeed deed, Mobile from, Item item, Item mar, int mesg, bool dele) : base(100, 80)   // Vii edit
        {
            this.Closable = true;
        ...
        public class TransObject : Target
        {
            ...
            public bool obj;
            public int m;
            public AppearanceChangeDeed tdeed;  // Vii edit

            public int weaponitemID;

            public TransObject(AppearanceChangeDeed deed, Mobile from, Item item, Item mar, int mesg, bool dele, bool ob)
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
			...
			if (o_item.ItemID == t_item.ItemID)
			{
                        ...
                        t_item.Delete();
                        m_From.SendMessage("You changed the appearance of your equipment.");
