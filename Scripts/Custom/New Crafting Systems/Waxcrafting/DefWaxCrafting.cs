...
//		}
		...
		public override void InitCraftList()
		{
			...
			/* Begin Ressources */
			index = AddCraft( typeof( CandleWick ), "Ressources", "Candle Wick", 50.0, 80.0, typeof( Beeswax ), "Wax", 1, "You dont have enough wax" );
			AddRes( index, typeof( Cloth ), "Cloth", 1, "You dont have enough cloth" );
			SetNeedHeat( index, true );

			index = AddCraft( typeof( BlankCandle ), "Ressources", "Blank Candle", 50.0, 80.0, typeof( Beeswax ), "Wax", 2, "You dont have enough wax" );
			SetNeedHeat( index, true );
			/* End Ressources */
