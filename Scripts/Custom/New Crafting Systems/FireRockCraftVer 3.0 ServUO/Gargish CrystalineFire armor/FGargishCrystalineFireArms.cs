...
{
    public class FGargishCrystalineFireArms : BaseArmor
    {
        ...
        [Constructable]
        public FGargishCrystalineFireArms()
            : base(0x0307)
        {
            Name = "F Gargish CrystalineFire Arms";
            Hue = 1357;
            Weight = 5.0;
        ...
        public FGargishCrystalineFireArms(Serial serial)
            : base(serial)
        {
        }
