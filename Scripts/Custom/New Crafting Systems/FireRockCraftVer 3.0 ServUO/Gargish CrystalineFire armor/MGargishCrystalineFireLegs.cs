...
{
	public class MGargishCrystalineFireLegs : BaseArmor
	{
		...
		[Constructable]
		public MGargishCrystalineFireLegs() : base( 0x1411 )
		{
            Name = "M Gargish CrystalineFire Legs";
            Hue = 1357;
			Weight = 7.0;
        ...
        public MGargishCrystalineFireLegs(Serial serial)
            : base(serial)
		{
		}
