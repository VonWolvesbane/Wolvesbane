...
{
	public class MGargishCrystalineFireChest : BaseArmor
	{
		...
		public override int StrReq{ get{ return 95; } }
		...
		[Constructable]
        public MGargishCrystalineFireChest()
            : base(0x030A)
		{
            Name = "M Gargish CrystalineFire Chest";
            Hue = 1357;
			Weight = 10.0;
        ...
        public MGargishCrystalineFireChest(Serial serial)
            : base(serial)
		{
		}
