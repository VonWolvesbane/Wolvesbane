...
namespace Server.Items
{
	...
	public class FGargishCrystalineFireLegs : BaseArmor
	{
		...
		[Constructable]
		public FGargishCrystalineFireLegs() : base( 0x1411 )
		{
            Name = "F Gargish CrystalineFire Legs";
            Hue = 1357;
			Weight = 7.0;
        ...
        public FGargishCrystalineFireLegs(Serial serial)
            : base(serial)
		{
		}
