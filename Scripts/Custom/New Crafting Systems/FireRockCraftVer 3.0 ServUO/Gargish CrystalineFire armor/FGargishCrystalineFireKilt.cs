...
{
	public class FGargishCrystalineFireKilt : BaseArmor
	{
		...
		[Constructable]
        public FGargishCrystalineFireKilt()
            : base(0x030B)
		{
            Name = "F Gargish CrystalineFire Kilt";
            Hue = 1357;
			Weight = 7.0;
        ...
        public FGargishCrystalineFireKilt(Serial serial)
            : base(serial)
		{
		}
