...
namespace Server.Items
{
	public class   perilousCrystal : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( NecroSkill < 80.0 )
			{
				from.SendMessage( "You must have at least 80.0 skill in necromancy to construct a ghast." );
				return;
			}
			...
			switch ( res )
			{
				case 0:
				{
					from.SendMessage( "You must have a poisioned rotting torso to construct the ghast." );
					break;
				}
				case 1:
				{
					from.SendMessage( "You must have a pair of rotting legs to construct the ghast." );
					break;
				}
				default:
				{
