...
namespace Server.Engines.Craft
{
	...
	public class DefWeaving : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			#region Rugs
			index = AddCraft( typeof( BlueRugDeed ), 1076602, "Blue rug", 105.0, 125.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( BluePlainRugDeed ), 1076602, 1076585, 107.0, 127.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( BlueFancyRugDeed ), 1076602, 1076273, 110.2, 130.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( BlueDecorativeRugDeed ), 1076602, 1076589, 115.0, 130.5, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( RedRugDeed ), 1076602, "Red rug", 105.0, 125.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( RedPlainRugDeed ), 1076602, 1076588, 107.0, 127.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( CinnamonRugDeed ), 1076602, "Large cinnamon rug", 105.0, 125.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( CinnamonFancyRugDeed ), 1076602, 1076587, 110.2, 130.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			...
			index = AddCraft( typeof( GoldenRugDeed ), 1076602, "Large golden rug", 105.0, 125.0, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
			
			index = AddCraft( typeof( GoldenDecorativeRugDeed ), 1076602, 1076586, 115.0, 130.5, typeof( Wool ), "Wool", 24, "You don't have enough wool to make that" );
			AddRes( index, typeof( Dyes ), 1024009, 6, 1044253 );
			AddRes( index, typeof( Flax ), 1026809, 1, 1044253 );
