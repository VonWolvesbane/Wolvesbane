...
{
    [DispellableField]
    public class Item120Moongate : Item
    {
        ...
        [Constructable]
        public Item120Moongate(bool bDispellable)
            : this(Point3D.Zero, null)
        {
        ...
        [Constructable]
        public Item120Moongate(Point3D target, Map targetMap)
            : base(0xF6C)
        {
            Movable = false;
        ...
        public Item120Moongate(Serial serial)
            : base(serial)
        { }
        ...
        private class DelayTimer : Timer
        {
            ...
            private readonly Item120Moongate m_Gate;
            private readonly int m_Range;

            public DelayTimer(Mobile from, Item120Moongate gate, int range)
