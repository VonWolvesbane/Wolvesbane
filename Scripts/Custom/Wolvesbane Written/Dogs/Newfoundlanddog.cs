...
{
    [CorpseName("a newfoundland corpse")]
    public class Newfoundland : BaseMount
    {
        [Constructable]
        public Newfoundland()
            : this("a Newfoundland")
        ...
        public Newfoundland(string name)
            : base(name, 1546, 0x3ED4, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
        ...
        public Newfoundland(Serial serial)
            : base(serial)
        {
        }
