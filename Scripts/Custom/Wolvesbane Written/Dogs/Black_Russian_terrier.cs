...
{
    [CorpseName("a Black Russian Terrier corpse")]
    public class Black_Russian_terrier : BaseMount
    {
        [Constructable]
        public Black_Russian_terrier()
            : this("a Black Russian Terrier")
        {
        }

        [Constructable]
        public Black_Russian_terrier(string name)
            : base(name, 1551, 0x3ED8, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
        ...
        public Black_Russian_terrier(Serial serial)
            : base(serial)
        {
        }
