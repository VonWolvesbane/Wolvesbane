...
{
    [CorpseName("a Saint Bernard corpse")]
    public class Saint_Bernard : BaseMount
    {
        [Constructable]
        public Saint_Bernard()
            : this("a Saint Bernard")
        {
        }

        [Constructable]
        public Saint_Bernard(string name)
            : base(name, 1549, 0x3ED7, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
        ...
        public Saint_Bernard(Serial serial)
            : base(serial)
        {
        }
