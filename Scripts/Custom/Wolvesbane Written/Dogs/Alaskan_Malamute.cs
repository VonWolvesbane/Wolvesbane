...
{
    [CorpseName("a Alaskan Malamute")]
    public class Alaskan_Malamute : BaseMount
    {
        [Constructable]
        public Alaskan_Malamute()
            : this("an Alaskan Malamute")
        {
        }

        [Constructable]
        public Alaskan_Malamute(string name)
            : base(name, 1547, 0x3ED5, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
        ...
        public Alaskan_Malamute(Serial serial)
            : base(serial)
        {
        }
