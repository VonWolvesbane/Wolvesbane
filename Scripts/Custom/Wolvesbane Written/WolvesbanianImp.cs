...
namespace Server.Mobiles
{
    ...
    public class WolvesbanianImp : BaseCreature
    {
        ...
        [Constructable]
        public WolvesbanianImp()
            : this("a Wolvesbanian Imp")
        {
        }
        ...
        public WolvesbanianImp(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnGaveMeleeAttack(Mobile defender)
        {
            ...
            if (0.1 > Utility.RandomDouble())
            {
                ...
                {
                    timer.DoExpire();
                    defender.SendMessage("The imps fangs pour more venom into your already weakend body."); 
                }
                else
                    defender.SendMessage("The imp sinks it's fangs into your flesh, releasing it's toxic venom!"); 
