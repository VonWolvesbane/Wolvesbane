...
namespace Xanthos.Evo
{
	...
	public abstract class BaseChivMountEvo : BaseMount, IEvoCreature
	{
		...
		public BaseChivMountEvo( string name, int bodyID, int itemID ) : base( name, bodyID, itemID, AIType.AI_Paladin, FightMode.Closest, 10, 1, 0.2, 0.1 )
		{
			Name = name;
			Init();
			InitAI();
		...
		public BaseChivMountEvo( Serial serial ) : base( serial )
		{
		}
