/// Doc - Puppy N. Addon for The Playground UO  from.PlaySound( 0x086 );
using System;
using Server;
using Server.Items;
...
{
	public class PuppyNAddon : BaseAddon
	{
		...
		public PuppyNAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class PuppyNAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new PuppyNAddon();
			}
		}

		[Constructable]
		public PuppyNAddonDeed()
		{
			Name = "PuppyN";
		}

		public PuppyNAddonDeed( Serial serial ) : base( serial )
		{
		}
