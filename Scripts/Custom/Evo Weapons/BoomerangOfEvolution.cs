...
{
	public class BoomerangOfEvolution : Boomerang
	{
		...
		[Constructable]
		public BoomerangOfEvolution()
		{	Name = "Boomerang Of Evolution";
			Hue = 0x4F2;
        ...
        public BoomerangOfEvolution(Serial serial)
            : base(serial)
        {
        }
		public override int MinThrowRange { get { return 3; } }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Boomerang Of Evolution (" + mEvolutionPoints.ToString() + ")";
