...
{
	public class DualShortAxesOfEvolution : DualShortAxes
	{
		...
		[Constructable]
		public DualShortAxesOfEvolution()
		{	Name = "Dual Short Axes Of Evolution";
			Hue = 0x4F2;
        ...
        public DualShortAxesOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Dual Short Axes Of Evolution (" + mEvolutionPoints.ToString() + ")";
