...
{
	public class MaceOfEvolution : Mace
	{
		...
		[Constructable]
		public MaceOfEvolution()
		{	Name = "Mace Of Evolution";
			Hue = 0x4F2;
        ...
        public MaceOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Mace Of Evolution (" + mEvolutionPoints.ToString() + ")";
