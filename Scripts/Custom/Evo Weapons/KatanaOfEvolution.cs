...
{
	public class KatanaOfEvolution : Katana
	{
		...
		[Constructable]
		public KatanaOfEvolution()
		{	Name = "Katana Of Evolution";
			Hue = 0x4F2;
        ...
        public KatanaOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Katana Of Evolution (" + mEvolutionPoints.ToString() + ")";
