...
{
	public class ElvenCompositeLongbowOfEvolution : ElvenCompositeLongbow
	{
		...
		[Constructable]
		public ElvenCompositeLongbowOfEvolution()
		{	Name = "Elven Composite Longbow Of Evolution";
			Hue = 0x4F2;
        ...
        public ElvenCompositeLongbowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Elven Composite Longbow Of Evolution (" + mEvolutionPoints.ToString() + ")";
