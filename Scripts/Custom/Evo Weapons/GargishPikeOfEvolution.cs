...
{
	public class GargishPikeOfEvolution : GargishPike
	{
		...
		[Constructable]
		public GargishPikeOfEvolution()
		{	Name = "Gargish Pike Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishPikeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Pike Of Evolution (" + mEvolutionPoints.ToString() + ")";
