...
{
	public class DualPointedSpearOfEvolution : DualPointedSpear
	{
		...
		[Constructable]
		public DualPointedSpearOfEvolution()
		{	Name = "Dual Pointed Spear Of Evolution";
			Hue = 0x4F2;
        ...
        public DualPointedSpearOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Dual Pointed Spear Of Evolution (" + mEvolutionPoints.ToString() + ")";
