...
{
	public class RadiantScimitarOfEvolution : RadiantScimitar
	{
		...
		[Constructable]
		public RadiantScimitarOfEvolution()
		{	Name = "Radiant Scimitar Of Evolution";
			Hue = 0x4F2;
        ...
        public RadiantScimitarOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Radiant Scimitar Of Evolution (" + mEvolutionPoints.ToString() + ")";
