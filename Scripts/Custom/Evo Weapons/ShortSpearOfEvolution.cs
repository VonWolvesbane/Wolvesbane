...
{
	public class ShortSpearOfEvolution : ShortSpear
	{
		...
		[Constructable]
		public ShortSpearOfEvolution()
		{	Name = "Short Spear Of Evolution";
			Hue = 0x4F2;
        ...
        public ShortSpearOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Short Spear Of Evolution (" + mEvolutionPoints.ToString() + ")";
