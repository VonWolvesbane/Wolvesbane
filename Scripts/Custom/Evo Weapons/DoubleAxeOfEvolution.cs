...
{
	public class DoubleAxeOfEvolution : DoubleAxe
	{
		...
		[Constructable]
		public DoubleAxeOfEvolution()
		{	Name = "Double Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public DoubleAxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Double Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
