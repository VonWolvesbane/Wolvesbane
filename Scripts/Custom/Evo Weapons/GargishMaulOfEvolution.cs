...
{
	public class GargishMaulOfEvolution : GargishMaul
	{
		...
		[Constructable]
		public GargishMaulOfEvolution()
		{	Name = "Gargish Maul Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishMaulOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Maul Of Evolution (" + mEvolutionPoints.ToString() + ")";
