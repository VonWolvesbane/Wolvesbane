...
{
	public class BoneHarvesterOfEvolution : BoneHarvester
	{
		...
		[Constructable]
		public BoneHarvesterOfEvolution()
		{	Name = "Bone Harvester Of Evolution";
			Hue = 0x4F2;
        ...
        public BoneHarvesterOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Bone Harvester Of Evolution (" + mEvolutionPoints.ToString() + ")";
