...
{
	public class GnarledStaffOfEvolution : GnarledStaff
	{
		...
		[Constructable]
		public GnarledStaffOfEvolution()
		{	Name = "Gnarled Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public GnarledStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gnarled Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
