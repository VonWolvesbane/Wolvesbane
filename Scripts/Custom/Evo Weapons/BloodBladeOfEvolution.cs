...
{
	public class BloodBladeOfEvolution : BloodBlade
	{
		...
		[Constructable]
		public BloodBladeOfEvolution()
		{	Name = "Blood Blade Of Evolution";
			Hue = 0x4F2;
        ...
        public BloodBladeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Blood Blade Of Evolution (" + mEvolutionPoints.ToString() + ")";
