...
{
	public class HeavyCrossbowOfEvolution : HeavyCrossbow
	{
		...
		[Constructable]
		public HeavyCrossbowOfEvolution()
		{	Name = "Heavy Crossbow Of Evolution";
			Hue = 0x4F2;
        ...
        public HeavyCrossbowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Heavy Crossbow Of Evolution (" + mEvolutionPoints.ToString() + ")";
