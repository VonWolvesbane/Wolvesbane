...
{
	public class LajatangOfEvolution : Lajatang
	{
		...
		[Constructable]
		public LajatangOfEvolution()
		{	Name = "Lajatang Of Evolution";
			Hue = 0x4F2;
        ...
        public LajatangOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Lajatang Of Evolution (" + mEvolutionPoints.ToString() + ")";
