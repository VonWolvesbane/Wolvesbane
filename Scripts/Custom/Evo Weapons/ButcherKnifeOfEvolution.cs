...
{
	public class ButcherKnifeOfEvolution : ButcherKnife
	{
		...
		[Constructable]
		public ButcherKnifeOfEvolution()
		{	Name = "Butcher Knife Of Evolution";
			Hue = 0x4F2;
        ...
        public ButcherKnifeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Butcher Knife Of Evolution (" + mEvolutionPoints.ToString() + ")";
