...
{
	public class ClubOfEvolution : Club
	{
		...
		[Constructable]
		public ClubOfEvolution()
		{	Name = "Club Of Evolution";
			Hue = 0x4F2;
        ...
        public ClubOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Club Of Evolution (" + mEvolutionPoints.ToString() + ")";
