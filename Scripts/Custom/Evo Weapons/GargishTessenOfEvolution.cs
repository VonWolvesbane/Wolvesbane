...
{
	public class GargishTessenOfEvolution : GargishTessen
	{
                
		public override WeaponAbility PrimaryAbility{ get{ return WeaponAbility.Feint; } }
		public override WeaponAbility SecondaryAbility{ get{ return WeaponAbility.DualWield; } }
		...
		[Constructable]
		public GargishTessenOfEvolution()
		{	Name = "Gargish Tessen Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishTessenOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Tessen Of Evolution (" + mEvolutionPoints.ToString() + ")";
