...
{
	public class WakizashiOfEvolution : Wakizashi
	{
		...
		[Constructable]
		public WakizashiOfEvolution()
		{	Name = "Wakizashi Of Evolution";
			Hue = 0x4F2;
        ...
        public WakizashiOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Wakizashi Of Evolution (" + mEvolutionPoints.ToString() + ")";
