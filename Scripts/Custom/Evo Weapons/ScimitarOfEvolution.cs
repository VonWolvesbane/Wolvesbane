...
{
	public class ScimitarOfEvolution : Scimitar
	{
		...
		[Constructable]
		public ScimitarOfEvolution()
		{	Name = "Scimitar Of Evolution";
			Hue = 0x4F2;
        ...
        public ScimitarOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Scimitar Of Evolution (" + mEvolutionPoints.ToString() + ")";
