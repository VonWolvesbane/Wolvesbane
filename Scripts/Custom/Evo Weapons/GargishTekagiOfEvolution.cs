...
{
	public class GargishTekagiOfEvolution : GargishTekagi
	{
		...
		[Constructable]
		public GargishTekagiOfEvolution()
		{	Name = "Gargish Tekagi Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishTekagiOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Tekagi Of Evolution (" + mEvolutionPoints.ToString() + ")";
