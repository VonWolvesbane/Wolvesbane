...
{
	public class ElvenSpellbladeOfEvolution : ElvenSpellblade
	{
		...
		[Constructable]
		public ElvenSpellbladeOfEvolution()
		{	Name = "Elven Spellblade Of Evolution";
			Hue = 0x4F2;
        ...
        public ElvenSpellbladeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Elven Spellblade Of Evolution (" + mEvolutionPoints.ToString() + ")";
