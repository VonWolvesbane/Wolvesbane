...
{
	public class GargishTalwarOfEvolution : GargishTalwar
	{
		...
		[Constructable]
		public GargishTalwarOfEvolution()
		{	Name = "Gargish Talwar Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishTalwarOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Talwar Of Evolution (" + mEvolutionPoints.ToString() + ")";
