...
{
	public class BokutoOfEvolution : Bokuto
	{
		...
		[Constructable]
		public BokutoOfEvolution()
		{	Name = "Bokuto Of Evolution";
			Hue = 0x4F2;
        ...
        public BokutoOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Bokuto Of Evolution (" + mEvolutionPoints.ToString() + ")";
