...
{
	public class DaggerOfEvolution : Dagger
	{
		...
		[Constructable]
		public DaggerOfEvolution()
		{	Name = "Dagger Of Evolution";
			Hue = 0x4F2;
        ...
        public DaggerOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Dagger Of Evolution (" + mEvolutionPoints.ToString() + ")";
