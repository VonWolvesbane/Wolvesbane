...
{
	public class GlassStaffOfEvolution : GlassStaff
	{
		...
		[Constructable]
		public GlassStaffOfEvolution()
		{	Name = "Glass Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public GlassStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Glass Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
