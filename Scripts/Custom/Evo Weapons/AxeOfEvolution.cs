...
{
	public class AxeOfEvolution : Axe
	{
		...
		[Constructable]
		public AxeOfEvolution()
		{	Name = "Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public AxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
