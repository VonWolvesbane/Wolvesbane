...
{
	public class CutlassOfEvolution : Cutlass
	{
		...
		[Constructable]
		public CutlassOfEvolution()
		{	Name = "Cutlass Of Evolution";
			Hue = 0x4F2;
        ...
        public CutlassOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Cutlass Of Evolution (" + mEvolutionPoints.ToString() + ")";
