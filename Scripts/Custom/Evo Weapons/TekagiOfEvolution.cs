...
{
	public class TekagiOfEvolution : Tekagi
	{
		...
		[Constructable]
		public TekagiOfEvolution()
		{	Name = "Tekagi Of Evolution";
			Hue = 0x4F2;
        ...
        public TekagiOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Tekagi Of Evolution (" + mEvolutionPoints.ToString() + ")";
