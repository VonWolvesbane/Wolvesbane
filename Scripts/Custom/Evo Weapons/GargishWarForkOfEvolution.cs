...
{
	public class GargishWarForkOfEvolution : GargishWarFork
	{
		...
		[Constructable]
		public GargishWarForkOfEvolution()
		{	Name = "Gargish War Fork Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishWarForkOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish War Fork Of Evolution (" + mEvolutionPoints.ToString() + ")";
