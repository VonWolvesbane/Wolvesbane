...
{
	public class GargishGnarledStaffOfEvolution : GargishGnarledStaff
	{
		...
		[Constructable]
		public GargishGnarledStaffOfEvolution()
		{	Name = "Gargish Gnarled Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishGnarledStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Gnarled Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
