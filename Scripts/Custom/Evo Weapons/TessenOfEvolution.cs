...
{
	public class TessenOfEvolution : Tessen
	{
		...
		[Constructable]
		public TessenOfEvolution()
		{	Name = "Tessen Of Evolution";
			Hue = 0x4F2;
        ...
        public TessenOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Tessen Of Evolution (" + mEvolutionPoints.ToString() + ")";
