...
{
	public class LanceOfEvolution : Lance
	{
		...
		[Constructable]
		public LanceOfEvolution()
		{	Name = "Lance Of Evolution";
			Hue = 0x4F2;
        ...
        public LanceOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Lance Of Evolution (" + mEvolutionPoints.ToString() + ")";
