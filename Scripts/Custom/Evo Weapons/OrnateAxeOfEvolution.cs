...
{
	public class OrnateAxeOfEvolution : OrnateAxe
	{
		...
		[Constructable]
		public OrnateAxeOfEvolution()
		{	Name = "Ornate Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public OrnateAxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Ornate Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
