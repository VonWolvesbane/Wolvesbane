...
{
	public class GargishDaggerOfEvolution : GargishDagger
	{
		...
		[Constructable]
		public GargishDaggerOfEvolution()
		{	Name = "Gargish Dagger Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishDaggerOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Dagger Of Evolution (" + mEvolutionPoints.ToString() + ")";
