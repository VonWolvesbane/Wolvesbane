...
{
	public class DreadSwordOfEvolution : DreadSword
	{
		...
		[Constructable]
		public DreadSwordOfEvolution()
		{	Name = "Dread Sword Of Evolution";
			Hue = 0x4F2;
        ...
        public DreadSwordOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Dread Sword Of Evolution (" + mEvolutionPoints.ToString() + ")";
