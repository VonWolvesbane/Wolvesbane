...
{
	public class VikingSwordOfEvolution : VikingSword
	{
		...
		[Constructable]
		public VikingSwordOfEvolution()
		{	Name = "Viking Sword Of Evolution";
			Hue = 0x4F2;
        ...
        public VikingSwordOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Viking Sword Of Evolution (" + mEvolutionPoints.ToString() + ")";
