...
{
	public class TetsuboOfEvolution : Tetsubo
	{
		...
		[Constructable]
		public TetsuboOfEvolution()
		{	Name = "Tetsubo Of Evolution";
			Hue = 0x4F2;
        ...
        public TetsuboOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Tetsubo Of Evolution (" + mEvolutionPoints.ToString() + ")";
