...
{
	public class CycloneOfEvolution : Cyclone
	{
		...
		[Constructable]
		public CycloneOfEvolution()
		{	Name = "Cyclone Of Evolution";
			Hue = 0x4F2;
        ...
        public CycloneOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Cyclone Of Evolution (" + mEvolutionPoints.ToString() + ")";
