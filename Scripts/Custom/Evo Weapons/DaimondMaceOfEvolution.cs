...
{
	public class DiamondMaceOfEvolution : DiamondMace
	{
		...
		[Constructable]
		public DiamondMaceOfEvolution()
		{	Name = "Diamond Mace Of Evolution";
			Hue = 0x4F2;
        ...
        public DiamondMaceOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Diamond Mace Of Evolution (" + mEvolutionPoints.ToString() + ")";
