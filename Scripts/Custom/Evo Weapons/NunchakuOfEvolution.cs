...
{
	public class NunchakuOfEvolution : Nunchaku
	{
		...
		[Constructable]
		public NunchakuOfEvolution()
		{	Name = "Nunchaku Of Evolution";
			Hue = 0x4F2;
        ...
        public NunchakuOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Nunchaku Of Evolution (" + mEvolutionPoints.ToString() + ")";
