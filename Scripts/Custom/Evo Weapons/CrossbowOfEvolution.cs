...
{
	public class CrossbowOfEvolution : Crossbow
	{
		...
		[Constructable]
		public CrossbowOfEvolution()
		{	Name = "Crossbow Of Evolution";
			Hue = 0x4F2;
        ...
        public CrossbowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Crossbow Of Evolution (" + mEvolutionPoints.ToString() + ")";
