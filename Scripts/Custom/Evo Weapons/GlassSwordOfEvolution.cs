...
{
	public class GlassSwordOfEvolution : GlassSword
	{
		...
		[Constructable]
		public GlassSwordOfEvolution()
		{	Name = "Glass Sword Of Evolution";
			Hue = 0x4F2;
        ...
        public GlassSwordOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Glass Sword Of Evolution (" + mEvolutionPoints.ToString() + ")";
