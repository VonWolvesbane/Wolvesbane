...
{
	public class WarForkOfEvolution : WarFork
	{
		...
		[Constructable]
		public WarForkOfEvolution()
		{	Name = "War Fork Of Evolution";
			Hue = 0x4F2;
        ...
        public WarForkOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "War Fork Of Evolution (" + mEvolutionPoints.ToString() + ")";
