...
{
	public class SkinningKnifeOfEvolution : SkinningKnife
	{
		...
		[Constructable]
		public SkinningKnifeOfEvolution()
		{	Name = "Skinning Knife Of Evolution";
			Hue = 0x4F2;
        ...
        public SkinningKnifeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Skinning Knife Of Evolution (" + mEvolutionPoints.ToString() + ")";
