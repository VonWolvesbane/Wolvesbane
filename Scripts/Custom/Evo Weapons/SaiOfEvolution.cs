...
{
	public class SaiOfEvolution : Sai
	{
		...
		[Constructable]
		public SaiOfEvolution()
		{	Name = "Sai Of Evolution";
			Hue = 0x4F2;
        ...
        public SaiOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Sai Of Evolution (" + mEvolutionPoints.ToString() + ")";
