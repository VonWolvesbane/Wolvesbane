...
{
	public class ShortbladeOfEvolution : Shortblade
	{
		...
		[Constructable]
		public ShortbladeOfEvolution()
		{	Name = "Shortblade Of Evolution";
			Hue = 0x4F2;
        ...
        public ShortbladeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Shortblade Of Evolution (" + mEvolutionPoints.ToString() + ")";
