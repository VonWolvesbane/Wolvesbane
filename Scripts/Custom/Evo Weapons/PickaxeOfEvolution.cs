...
{
	public class PickaxeOfEvolution : Pickaxe
	{
		...
		[Constructable]
		public PickaxeOfEvolution()
		{	Name = "Pickaxe Of Evolution";
			Hue = 0x4F2;
        ...
        public PickaxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Pickaxe Of Evolution (" + mEvolutionPoints.ToString() + ")";
