...
{
	public class NoDachiOfEvolution : NoDachi
	{
		...
		[Constructable]
		public NoDachiOfEvolution()
		{	Name = "NoDachi Of Evolution";
			Hue = 0x4F2;
        ...
        public NoDachiOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "NoDachi Of Evolution (" + mEvolutionPoints.ToString() + ")";
