...
{
	public class CleaverOfEvolution : Cleaver
	{
		...
		[Constructable]
		public CleaverOfEvolution()
		{	Name = "Cleaver Of Evolution";
			Hue = 0x4F2;
        ...
        public CleaverOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Cleaver Of Evolution (" + mEvolutionPoints.ToString() + ")";
