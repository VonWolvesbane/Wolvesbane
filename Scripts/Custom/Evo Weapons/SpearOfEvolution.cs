...
{
	public class SpearOfEvolution : Spear
	{
		...
		[Constructable]
		public SpearOfEvolution()
		{	Name = "Spear Of Evolution";
			Hue = 0x4F2;
        ...
        public SpearOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Spear Of Evolution (" + mEvolutionPoints.ToString() + ")";
