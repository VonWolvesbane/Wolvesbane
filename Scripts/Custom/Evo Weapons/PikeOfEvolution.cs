...
{
	public class PikeOfEvolution : Pike
	{
		...
		[Constructable]
		public PikeOfEvolution()
		{	Name = "Pike Of Evolution";
			Hue = 0x4F2;
        ...
        public PikeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Pike Of Evolution (" + mEvolutionPoints.ToString() + ")";
