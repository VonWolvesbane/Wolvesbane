...
{
	public class ShepherdsCrookOfEvolution : ShepherdsCrook
	{
		...
		[Constructable]
		public ShepherdsCrookOfEvolution()
		{	Name = "Shepherds Crook Of Evolution";
			Hue = 0x4F2;
        ...
        public ShepherdsCrookOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Shepherds Crook Of Evolution (" + mEvolutionPoints.ToString() + ")";
