...
{
	public class ScytheOfEvolution : Scythe
	{
		...
		[Constructable]
		public ScytheOfEvolution()
		{	Name = "Scythe Of Evolution";
			Hue = 0x4F2;
        ...
        public ScytheOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Scythe Of Evolution (" + mEvolutionPoints.ToString() + ")";
