...
{
	public class BattleAxeOfEvolution : BattleAxe
	{
		...
		[Constructable]
		public BattleAxeOfEvolution()
		{	Name = "Battle Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public BattleAxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Battle Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
