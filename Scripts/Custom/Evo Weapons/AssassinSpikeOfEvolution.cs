...
{
	public class AssassinSpikeOfEvolution : AssassinSpike
	{
		...
		[Constructable]
		public AssassinSpikeOfEvolution()
		{	Name = "AssassinSpike Of Evolution";
			Hue = 0x4F2;
        ...
        public AssassinSpikeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "AssassinSpike Of Evolution (" + mEvolutionPoints.ToString() + ")";
