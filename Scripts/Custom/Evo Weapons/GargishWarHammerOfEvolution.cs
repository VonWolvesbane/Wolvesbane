...
{
	public class GargishWarHammerOfEvolution : GargishWarHammer
	{
		...
		[Constructable]
		public GargishWarHammerOfEvolution()
		{	Name = "Gargish War Hammer Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishWarHammerOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish War Hammer Of Evolution (" + mEvolutionPoints.ToString() + ")";
