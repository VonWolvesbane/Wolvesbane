...
{
	public class KryssOfEvolution : Kryss
	{
		...
		[Constructable]
		public KryssOfEvolution()
		{	Name = "Kryss Of Evolution";
			Hue = 0x4F2;
        ...
        public KryssOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Kryss Of Evolution (" + mEvolutionPoints.ToString() + ")";
