...
{
	public class RepeatingCrossbowOfEvolution : RepeatingCrossbow
	{
		...
		[Constructable]
		public RepeatingCrossbowOfEvolution()
		{	Name = "Repeating Crossbow Of Evolution";
			Hue = 0x4F2;
        ...
        public RepeatingCrossbowOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Repeating Crossbow Of Evolution (" + mEvolutionPoints.ToString() + ")";
