...
{
	public class DoubleBladedStaffOfEvolution : DoubleBladedStaff
	{
		...
		[Constructable]
		public DoubleBladedStaffOfEvolution()
		{	Name = "Double Bladed Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public DoubleBladedStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Double Bladed Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
