...
{
	public class HalberdOfEvolution : Halberd
	{
		...
		[Constructable]
		public HalberdOfEvolution()
		{	Name = "Halberd Of Evolution";
			Hue = 0x4F2;
        ...
        public HalberdOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Halberd Of Evolution (" + mEvolutionPoints.ToString() + ")";
