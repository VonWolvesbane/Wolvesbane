...
{
	public class DaishoOfEvolution : Daisho
	{
		...
		[Constructable]
		public DaishoOfEvolution()
		{	Name = "Daisho Of Evolution";
			Hue = 0x4F2;
        ...
        public DaishoOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Daisho Of Evolution (" + mEvolutionPoints.ToString() + ")";
