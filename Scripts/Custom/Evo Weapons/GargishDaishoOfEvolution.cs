...
{
	public class GargishDaishoOfEvolution : GargishDaisho
	{
		...
		[Constructable]
		public GargishDaishoOfEvolution()
		{	Name = "Gargish Daisho Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishDaishoOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Daisho Of Evolution (" + mEvolutionPoints.ToString() + ")";
