...
{
	public class ScepterOfEvolution : Scepter
	{
		...
		[Constructable]
		public ScepterOfEvolution()
		{	Name = "Scepter Of Evolution";
			Hue = 0x4F2;
        ...
        public ScepterOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Scepter Of Evolution (" + mEvolutionPoints.ToString() + ")";
