...
{
	public class GargishCleaverOfEvolution : GargishCleaver
	{
		...
		[Constructable]
		public GargishCleaverOfEvolution()
		{	Name = "Gargish Cleaver Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishCleaverOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Cleaver Of Evolution (" + mEvolutionPoints.ToString() + ")";
