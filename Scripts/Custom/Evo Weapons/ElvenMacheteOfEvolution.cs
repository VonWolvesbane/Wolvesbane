...
{
	public class ElvenMacheteOfEvolution : ElvenMachete
	{
		...
		[Constructable]
		public ElvenMacheteOfEvolution()
		{	Name = "Elven Machete Of Evolution";
			Hue = 0x4F2;
        ...
        public ElvenMacheteOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Elven Machete Of Evolution (" + mEvolutionPoints.ToString() + ")";
