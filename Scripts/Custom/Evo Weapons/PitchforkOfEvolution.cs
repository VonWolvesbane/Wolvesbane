...
{
	public class PitchforkOfEvolution : Pitchfork
	{
		...
		[Constructable]
		public PitchforkOfEvolution()
		{	Name = "Pitchfork Of Evolution";
			Hue = 0x4F2;
        ...
        public PitchforkOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Pitchfork Of Evolution (" + mEvolutionPoints.ToString() + ")";
