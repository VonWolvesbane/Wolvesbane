...
{
	public class LongswordOfEvolution : Longsword
	{
		...
		[Constructable]
		public LongswordOfEvolution()
		{	Name = "Longsword Of Evolution";
			Hue = 0x4F2;
        ...
        public LongswordOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Longsword Of Evolution (" + mEvolutionPoints.ToString() + ")";
