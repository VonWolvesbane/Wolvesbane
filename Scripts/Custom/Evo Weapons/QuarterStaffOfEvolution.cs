...
{
	public class QuarterStaffOfEvolution : QuarterStaff
	{
		...
		[Constructable]
		public QuarterStaffOfEvolution()
		{	Name = "Quarter Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public QuarterStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Quarter Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
