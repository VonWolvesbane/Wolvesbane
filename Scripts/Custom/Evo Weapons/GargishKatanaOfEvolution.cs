...
{
	public class GargishKatanaOfEvolution : GargishKatana
	{
		...
		[Constructable]
		public GargishKatanaOfEvolution()
		{	Name = "Gargish Katana Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishKatanaOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Katana Of Evolution (" + mEvolutionPoints.ToString() + ")";
