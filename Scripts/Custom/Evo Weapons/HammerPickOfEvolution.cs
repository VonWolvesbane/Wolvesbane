...
{
	public class HammerPickOfEvolution : HammerPick
	{
		...
		[Constructable]
		public HammerPickOfEvolution()
		{	Name = "Hammer Pick Of Evolution";
			Hue = 0x4F2;
        ...
        public HammerPickOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Hammer Pick Of Evolution (" + mEvolutionPoints.ToString() + ")";
