...
{
	public class KamaOfEvolution : Kama
	{
		...
		[Constructable]
		public KamaOfEvolution()
		{	Name = "Kama Of Evolution";
			Hue = 0x4F2;
        ...
        public KamaOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Kama Of Evolution (" + mEvolutionPoints.ToString() + ")";
