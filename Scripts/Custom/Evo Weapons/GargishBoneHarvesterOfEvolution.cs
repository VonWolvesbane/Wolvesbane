...
{
	public class GargishBoneHarvesterOfEvolution : GargishBoneHarvester
	{
		...
		[Constructable]
		public GargishBoneHarvesterOfEvolution()
		{	Name = "Gargish Bone Harvester Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishBoneHarvesterOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Bone Harvester Of Evolution (" + mEvolutionPoints.ToString() + ")";
