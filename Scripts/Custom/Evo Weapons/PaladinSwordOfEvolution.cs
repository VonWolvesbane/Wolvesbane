...
{
	public class PaladinSwordOfEvolution : PaladinSword
	{
		...
		[Constructable]
		public PaladinSwordOfEvolution()
		{	Name = "Paladin Sword Of Evolution";
			Hue = 0x4F2;
        ...
        public PaladinSwordOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Paladin Sword Of Evolution (" + mEvolutionPoints.ToString() + ")";
