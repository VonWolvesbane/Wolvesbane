...
{
	public class GargishAxeOfEvolution : GargishAxe
	{
		...
		[Constructable]
		public GargishAxeOfEvolution()
		{	Name = "Gargish Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishAxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
