...
{
	public class LargeBattleAxeOfEvolution : LargeBattleAxe
	{
		...
		[Constructable]
		public LargeBattleAxeOfEvolution()
		{	Name = "Large Battle Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public LargeBattleAxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Large Battle Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
