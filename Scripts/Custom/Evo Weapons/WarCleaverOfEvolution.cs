...
{
	public class WarCleaverOfEvolution : WarCleaver
	{
		...
		[Constructable]
		public WarCleaverOfEvolution()
		{	Name = "War Cleaver Of Evolution";
			Hue = 0x4F2;
        ...
        public WarCleaverOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "War Cleaver Of Evolution (" + mEvolutionPoints.ToString() + ")";
