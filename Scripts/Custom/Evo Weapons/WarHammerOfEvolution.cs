...
{
	public class WarHammerOfEvolution : WarHammer
	{
		...
		[Constructable]
		public WarHammerOfEvolution()
		{	Name = "War Hammer Of Evolution";
			Hue = 0x4F2;
        ...
        public WarHammerOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "War Hammer Of Evolution (" + mEvolutionPoints.ToString() + ")";
