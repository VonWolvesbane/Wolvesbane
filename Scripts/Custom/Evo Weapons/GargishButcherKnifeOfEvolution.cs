...
{
	public class GargishButcherKnifeOfEvolution : GargishButcherKnife
	{
		...
		[Constructable]
		public GargishButcherKnifeOfEvolution()
		{	Name = "Gargish Butcher Knife Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishButcherKnifeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Butcher Knife Of Evolution (" + mEvolutionPoints.ToString() + ")";
