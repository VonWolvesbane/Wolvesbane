...
{
	public class SoulGlaiveOfEvolution : SoulGlaive
	{
		...
		[Constructable]
		public SoulGlaiveOfEvolution()
		{	Name = "Soul Glaive Of Evolution";
			Hue = 0x4F2;
        ...
        public SoulGlaiveOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Soul Glaive Of Evolution (" + mEvolutionPoints.ToString() + ")";
