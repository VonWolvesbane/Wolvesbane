...
{
	public class YumiOfEvolution : Yumi
	{
		...
		[Constructable]
		public YumiOfEvolution()
		{	Name = "Yumi Of Evolution";
			Hue = 0x4F2;
        ...
        public YumiOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Yumi Of Evolution (" + mEvolutionPoints.ToString() + ")";
