...
{
	public class DiscMaceOfEvolution : DiscMace
	{
		...
		[Constructable]
		public DiscMaceOfEvolution()
		{	Name = "Disc Mace Of Evolution";
			Hue = 0x4F2;
        ...
        public DiscMaceOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Disc Mace Of Evolution (" + mEvolutionPoints.ToString() + ")";
