...
{
	public class WarMaceOfEvolution : WarMace
	{
		...
		[Constructable]
		public WarMaceOfEvolution()
		{	Name = "War Mace Of Evolution";
			Hue = 0x4F2;
        ...
        public WarMaceOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "War Mace Of Evolution (" + mEvolutionPoints.ToString() + ")";
