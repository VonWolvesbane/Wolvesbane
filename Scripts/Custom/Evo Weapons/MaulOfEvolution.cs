...
{
	public class MaulOfEvolution : Maul
	{
		...
		[Constructable]
		public MaulOfEvolution()
		{	Name = "Maul Of Evolution";
			Hue = 0x4F2;
        ...
        public MaulOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Maul Of Evolution (" + mEvolutionPoints.ToString() + ")";
