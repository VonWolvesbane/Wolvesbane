...
{
	public class GargishKryssOfEvolution : GargishKryss
	{
		...
		[Constructable]
		public GargishKryssOfEvolution()
		{	Name = "Gargish Kryss Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishKryssOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Kryss Of Evolution (" + mEvolutionPoints.ToString() + ")";
