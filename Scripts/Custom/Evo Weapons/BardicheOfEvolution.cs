...
{
	public class BardicheOfEvolution : Bardiche
	{
		...
		[Constructable]
		public BardicheOfEvolution()
		{	Name = "Bardiche Of Evolution";
			Hue = 0x4F2;
        ...
        public BardicheOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Bardiche Of Evolution (" + mEvolutionPoints.ToString() + ")";
