...
{
	public class GargishScytheOfEvolution : GargishScythe
	{
		...
		[Constructable]
		public GargishScytheOfEvolution()
		{	Name = "Gargish Scythe Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishScytheOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Scythe Of Evolution (" + mEvolutionPoints.ToString() + ")";
