...
{
	public class WildStaffOfEvolution : WildStaff
	{
		...
		[Constructable]
		public WildStaffOfEvolution()
		{	Name = "Wild Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public WildStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Wild Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
