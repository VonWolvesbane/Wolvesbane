...
{
	public class BladedStaffOfEvolution : BladedStaff
	{
		...
		[Constructable]
		public BladedStaffOfEvolution()
		{	Name = "Bladed Staff Of Evolution";
			Hue = 0x4F2;
        ...
        public BladedStaffOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Bladed Staff Of Evolution (" + mEvolutionPoints.ToString() + ")";
