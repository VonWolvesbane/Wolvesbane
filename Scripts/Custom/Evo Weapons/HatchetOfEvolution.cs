...
{
	public class HatchetOfEvolution : Hatchet
	{
		...
		[Constructable]
		public HatchetOfEvolution()
		{	Name = "Hatchet Of Evolution";
			Hue = 0x4F2;
        ...
        public HatchetOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Hatchet Of Evolution (" + mEvolutionPoints.ToString() + ")";
