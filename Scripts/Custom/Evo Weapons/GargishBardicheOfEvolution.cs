...
{
	public class GargishBardicheOfEvolution : GargishBardiche
	{
		...
		[Constructable]
		public GargishBardicheOfEvolution()
		{	Name = "Gargish Bardiche Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishBardicheOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Bardiche Of Evolution (" + mEvolutionPoints.ToString() + ")";
