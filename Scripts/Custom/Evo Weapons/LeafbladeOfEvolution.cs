...
{
	public class LeafbladeOfEvolution : Leafblade
	{
		...
		[Constructable]
		public LeafbladeOfEvolution()
		{	Name = "Leafblade Of Evolution";
			Hue = 0x4F2;
        ...
        public LeafbladeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Leafblade Of Evolution (" + mEvolutionPoints.ToString() + ")";
