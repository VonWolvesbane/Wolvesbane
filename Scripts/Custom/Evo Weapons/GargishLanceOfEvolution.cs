...
{
	public class GargishLanceOfEvolution : GargishLance
	{
		...
		[Constructable]
		public GargishLanceOfEvolution()
		{	Name = "Gargish Lance Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishLanceOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Lance Of Evolution (" + mEvolutionPoints.ToString() + ")";
