...
{
	public class GargishBattleAxeOfEvolution : GargishBattleAxe
	{
		...
		[Constructable]
		public GargishBattleAxeOfEvolution()
		{	Name = "Gargish Battle Axe Of Evolution";
			Hue = 0x4F2;
        ...
        public GargishBattleAxeOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Battle Axe Of Evolution (" + mEvolutionPoints.ToString() + ")";
