...
{ 
	public class SkillMountOstard : EtherealMount 
	{ 
		[Constructable] 
		public SkillMountOstard() : base(0x2135, 0x3EAC, 0x3EA5) //base( 0x2135, 0x3EAc ) 
		{ 
			Name = "Ethereal Skill Ostard";
		...
		public SkillMountOstard( Serial serial ) : base( serial ) 
		{ 
		} 
