...
{
	[CorpseName( "a Donator's ki-rin corpse" )]
	public class DonatorKirin : BaseMount
	{
		...
		[Constructable]
		public DonatorKirin() : this( "a Donator's Ki-rin" )
		{
		}

		[Constructable]
		public DonatorKirin( string name ) : base( name, 132, 0x3EAD, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x3C5;
		...
		public DonatorKirin( Serial serial ) : base( serial )
		{
		}
