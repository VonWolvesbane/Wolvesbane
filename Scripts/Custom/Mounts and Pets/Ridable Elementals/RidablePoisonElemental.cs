...
namespace Server.Mobiles
{
	...
	public class RidablePoisonElemental : BaseMount
	{
		[Constructable]
		public RidablePoisonElemental() : this( "A Ridable Poison Elemental" )
		{
		}

        [Constructable]
        public RidablePoisonElemental(string name)
        ...
        public RidablePoisonElemental(Serial serial)
            : base(serial)
		{
		}
