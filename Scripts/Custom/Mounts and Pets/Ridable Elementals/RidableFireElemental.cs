...
namespace Server.Mobiles
{
	...
	public class RidableFireElemental : BaseMount
	{
		[Constructable]
		public RidableFireElemental() : this( "A Ridable Fire Elemental" )
		{
		}

        [Constructable]
        public RidableFireElemental(string name)
        ...
        public RidableFireElemental(Serial serial)
            : base(serial)
		{
		}
