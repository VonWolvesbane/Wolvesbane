...
{ 
	public class SkillMount : EtherealMount 
	{ 
		[Constructable] 
		public SkillMount() : base(0x2D9C, 0x3E92, 0x3E92, DefaultEtherealHue) //base( 11676, 0x3E92 ) 
		{ 
			Name = "Ethereal Skill Mount Statuette";
			ItemID = 11676;
		...
		public SkillMount( Serial serial ) : base( serial ) 
		{ 
		} 
