...
namespace Server.Mobiles
{
	...
	public class RainbowKirin : BaseMount
	{
        ...
        [Constructable]
		public RainbowKirin() : this( "a rainbow kirin" )
		{
		}

		[Constructable]
		public RainbowKirin( string name ) : base( name, 0xE2, 0x3EA0, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public RainbowKirin( Serial serial ) : base( serial )
		{
		}
