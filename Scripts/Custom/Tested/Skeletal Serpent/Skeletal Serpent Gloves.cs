...
{
	public class SkeletalSerpentGloves : BoneGloves
  {
      ...
      [Constructable]
		public SkeletalSerpentGloves()
		{
          Name = "Skeletal Serpent Gloves";
      ...
      Attributes.BonusMana = 15;
		...
		public SkeletalSerpentGloves( Serial serial ) : base( serial )
		{
		}
