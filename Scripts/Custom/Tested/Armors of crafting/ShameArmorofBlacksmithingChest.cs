...
{
	public class ShameArmorofBlacksmithingChest : RingmailChest
	{
		...
		[Constructable]
		public ShameArmorofBlacksmithingChest()
		{
			Name = "Shame Armor of Blacksmithing Chest";
			Hue = 2593;
			Weight = 3;
		...
		public ShameArmorofBlacksmithingChest( Serial serial ) : base( serial )
		{
		}
