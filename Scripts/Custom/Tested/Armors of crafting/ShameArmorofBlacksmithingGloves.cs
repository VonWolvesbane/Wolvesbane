...
{
	public class ShameArmorofBlacksmithingGloves : RingmailGloves
	{
		...
		[Constructable]
		public ShameArmorofBlacksmithingGloves()
		{
			Name = "Shame Armor of Blacksmithing Gloves";
			Hue = 2593;
			Weight = 3;
		...
		public ShameArmorofBlacksmithingGloves( Serial serial ) : base( serial )
		{
		}
