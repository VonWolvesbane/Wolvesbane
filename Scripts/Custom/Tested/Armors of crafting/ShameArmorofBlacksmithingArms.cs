...
{
	public class ShameArmorofBlacksmithingArms : RingmailArms
	{
		...
		[Constructable]
		public ShameArmorofBlacksmithingArms()
		{
			Name = "Shame Armor of Blacksmithing Arms";
			Hue = 2593;
			Weight = 3;
		...
		public ShameArmorofBlacksmithingArms( Serial serial ) : base( serial )
		{
		}
