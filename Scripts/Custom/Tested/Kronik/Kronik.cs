...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Kronik" )]
              public class Kronik : BaseCreature
              {
				private Timer m_Timer;
                                 [Constructable]
                                    public Kronik() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
                            {
                                               Name = "Kronik";
					                           Body = 400;
						                       Female = false; 
						                       Hue = 487;
						                       Title = "The Being of Doom";
                                               Body = 305; // Uncomment these lines and input values
			...
			PackGold( 11120, 31130 );


			Item KronikTome2 = new KronikTome2(); 
			KronikTome2.Movable = false; 
			AddItem( KronikTome2 );
                                 ...
                                 public override void GenerateLoot()
		{
			...
			{
                default: break;
                case 0: PackItem( new KronikTome() ); break;
				case 1: PackItem( new KronikAxe() ); break;
...
public Kronik( Serial serial ) : base( serial )
                      {
                      }
