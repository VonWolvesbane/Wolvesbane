...
{
    public class ManiacTailorGloves : LeatherGloves
    {
        ...
        [Constructable]
        public ManiacTailorGloves() 
        {
            Name = "Gloves of a Maniacal Tailor";
            Hue = 2075;
        ...
        public ManiacTailorGloves(Serial serial) : base( serial )
        {
        }
