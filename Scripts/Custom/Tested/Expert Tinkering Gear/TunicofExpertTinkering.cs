...
{
    public class TunicofExpertTinkering : LeatherChest
    {
        ...
        [Constructable]
        public TunicofExpertTinkering()
        {
            Name = "Tunic of Expert Tinkering";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("TunicofExpertTinkering");
        ...
        public TunicofExpertTinkering(Serial serial) : base( serial )
        {
        }
