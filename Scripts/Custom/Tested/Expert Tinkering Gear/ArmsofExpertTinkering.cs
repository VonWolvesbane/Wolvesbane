...
{
    public class ArmsofExpertTinkering : LeatherArms
    {
        ...
        [Constructable]
        public ArmsofExpertTinkering()
        {
            Name = "Arms of Expert Tinkering";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("ArmsofExpertTinkering");
        ...
        public ArmsofExpertTinkering(Serial serial) : base( serial )
        {
        }
