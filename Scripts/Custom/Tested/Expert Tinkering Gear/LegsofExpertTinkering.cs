...
{
    public class LegsofExpertTinkering : LeatherLegs
    {
        ...
        [Constructable]
        public LegsofExpertTinkering()
        {
            Name = "Legs of Expert Tinkering";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("LegsofExpertTinkering");
        ...
        public LegsofExpertTinkering(Serial serial) : base( serial )
        {
        }
