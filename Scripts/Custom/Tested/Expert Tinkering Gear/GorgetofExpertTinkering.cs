...
{
    public class GorgetofExpertTinkering : LeatherGorget
    {
        ...
        [Constructable]
        public GorgetofExpertTinkering()
        {
            Name = "Gorget of Expert Tinkering";
            Hue = 702;
        ...
        public GorgetofExpertTinkering(Serial serial) : base( serial )
        {
        }
