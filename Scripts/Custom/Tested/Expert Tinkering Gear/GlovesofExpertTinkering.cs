...
{
    public class GlovesofExpertTinkering : LeatherGloves
    {
        ...
        [Constructable]
        public GlovesofExpertTinkering()
        {
            Name = "Gloves of Expert Tinkering";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("GlovesofExpertTinkering");
        ...
        public GlovesofExpertTinkering(Serial serial) : base( serial )
        {
        }
