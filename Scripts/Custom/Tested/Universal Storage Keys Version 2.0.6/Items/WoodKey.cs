    ...
    public class WoodKey : BaseStoreKey, IRewardItem
    {
        ...
        public override List<StoreEntry> EntryStructure
        {
            get
            {
				...
				entry.Add(new ResourceEntry(typeof(PurpleHeartBoard),new Type[] { typeof(PurpleHeartLog) },"Purple Heart Wood Board"));
				entry.Add(new ResourceEntry(typeof(RedwoodBoard),new Type[] { typeof(RedwoodLog) },"Redwood Board"));
				entry.Add(new ResourceEntry(typeof(PetrifiedBoard),new Type[] { typeof(PetrifiedLog) },"Petrifiedwood Board"));
                #endregion
