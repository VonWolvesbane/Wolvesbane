...
{
    public class TunicofExpertSmithy : LeatherChest
    {
        ...
        [Constructable]
        public TunicofExpertSmithy()
        {
            Name = "Tunic of Expert Blacksmithing";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("TunicofExpertBlacksmithing");
        ...
        public TunicofExpertSmithy(Serial serial) : base( serial )
        {
        }
