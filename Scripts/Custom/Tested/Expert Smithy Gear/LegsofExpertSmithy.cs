...
{
    public class LegsofExpertSmithy : LeatherLegs
    {
        ...
        [Constructable]
        public LegsofExpertSmithy()
        {
            Name = "Legs of Expert Blacksmithing";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("LegsofExpertBlacksmithing");
        ...
        public LegsofExpertSmithy(Serial serial) : base( serial )
        {
        }
