...
{
    public class ArmsofExpertSmithy : LeatherArms
    {
        ...
        [Constructable]
        public ArmsofExpertSmithy()
        {
            Name = "Arms of Expert Blacksmithing";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("ArmsofExpertBlacksmithing");
        ...
        public ArmsofExpertSmithy(Serial serial) : base( serial )
        {
        }
