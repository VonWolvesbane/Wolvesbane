...
{
    public class GlovesofExpertSmithy : LeatherGloves
    {
        ...
        [Constructable]
        public GlovesofExpertSmithy()
        {
            Name = "Gloves of Expert Blacksmithing";
            Hue = 93;
        ...
        public GlovesofExpertSmithy(Serial serial) : base( serial )
        {
        }
