...
{
    public class GorgetofExpertSmithy : LeatherGorget
    {
        ...
        [Constructable]
        public GorgetofExpertSmithy()
        {
            Name = "Gorget of Expert Blacksmithing";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("GorgetofExpertBlacksmithing");
        ...
        public GorgetofExpertSmithy(Serial serial) : base( serial )
        {
        }
