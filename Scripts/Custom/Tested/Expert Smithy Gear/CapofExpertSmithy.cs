...
{
    public class CapofExpertSmithy : LeatherCap
    {
        ...
        [Constructable]
        public CapofExpertSmithy()
        {
            Name = "Cap of Expert Blacksmithing";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("CapofExpertBlacksmithing");
        ...
        public CapofExpertSmithy(Serial serial) : base( serial )
        {
        }
