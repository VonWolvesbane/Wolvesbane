...
{
    public class ParachutePants : TattsukeHakama
    {
        [Constructable]
        public ParachutePants()
        {
            this.Weight = 10;
            this.Hue = 18;
            this.Name = "Parachute Pants";
	    this.Layer = Layer.OuterLegs;
        ...
        public ParachutePants( Serial serial ) : base( serial )
        {
        }
