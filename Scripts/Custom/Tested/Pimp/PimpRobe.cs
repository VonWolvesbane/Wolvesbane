...
{
    public class PimpRobe : MaleKimono
    {
        [Constructable]
        public PimpRobe()
        {
            ...
            this.Attributes.RegenHits = 15;
            this.Attributes.RegenMana = 15;
            this.Attributes.RegenStam = 15;
        ...
        public PimpRobe( Serial serial ) : base( serial )
        {
        }
