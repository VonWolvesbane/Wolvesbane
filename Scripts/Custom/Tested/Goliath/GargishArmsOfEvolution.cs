//Heater GargishArms Of Evolution By: Sean (http://www.wftpradio.net/)
...
{
	public class GargishArmsOfEvolution: GargishLeatherArms
	{
		...
		[Constructable]
		public GargishArmsOfEvolution()
		{	Name = "Gargish Arms Of Evolution";
			Hue = 2177;

            ArmorAttributes.SelfRepair = 10;
        }

        public GargishArmsOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Arms Of Evolution (" + mEvolutionPoints.ToString() + ")";
