//Heater GargishLegs Of Evolution By: Sean (http://www.wftpradio.net/)
...
{
	public class GargishLegsOfEvolution: GargishLeatherLegs
	{
		...
		[Constructable]
		public GargishLegsOfEvolution()
		{	Name = "Gargish Legs Of Evolution";
			Hue = 2177;

            ArmorAttributes.SelfRepair = 10;
        }

        public GargishLegsOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Legs Of Evolution (" + mEvolutionPoints.ToString() + ")";
