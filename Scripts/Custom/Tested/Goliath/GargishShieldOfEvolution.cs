//Heater GargishShield Of Evolution By: Sean (http://www.wftpradio.net/)
...
namespace Server.Items
{
	public class GargishShieldOfEvolution: GargishKiteShield
	{
		...
		[Constructable]
		public GargishShieldOfEvolution()
		{	Name = "Gargish Shield Of Evolution";
			Hue = 2177;

            ArmorAttributes.SelfRepair = 10;
        }

        public GargishShieldOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Shield Of Evolution (" + mEvolutionPoints.ToString() + ")";
