...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of Goliath" )]
              public class Goliath : BaseCreature
              {

                                 [Constructable]
                                    public Goliath() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.1, 0.2 )
                            {
                                               Name = "Goliath";
                                               Hue = 0;
								Paralyzed = false;
                                               Body = 1433; // Uncomment these lines and input values
...
public override void GenerateLoot()
		{		
			switch ( Utility.Random( 75 ))
			{
				...
				case 0: PackItem( new GargishArmsOfEvolution() ); break;
				case 1: PackItem( new GargishChestOfEvolution() ); break;
				case 2: PackItem( new GargishWingArmorOfEvolution() ); break;
				case 3: PackItem( new GargishLegsOfEvolution() ); break;
				case 4: PackItem( new GargishShieldOfEvolution() ); break;
				case 5: PackItem( new GargishKiltOfEvolution() ); break;
