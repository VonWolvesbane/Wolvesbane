//Heater GargishChest Of Evolution By: Sean (http://www.wftpradio.net/)
...
{
	public class GargishChestOfEvolution: GargishLeatherChest
	{
		...
		[Constructable]
		public GargishChestOfEvolution()
		{	Name = "Gargish Chest Of Evolution";
			Hue = 2177;

            ArmorAttributes.SelfRepair = 10;
        }

        public GargishChestOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Chest Of Evolution (" + mEvolutionPoints.ToString() + ")";
