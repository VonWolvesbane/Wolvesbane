//Heater GargishKilt Of Evolution By: Sean (http://www.wftpradio.net/)
...
{
	public class GargishKiltOfEvolution: GargishLeatherKilt
	{
		...
		[Constructable]
		public GargishKiltOfEvolution()
		{	Name = "Gargish Kilt Of Evolution";
			Hue = 2177;

            ArmorAttributes.SelfRepair = 10;
        }

        public GargishKiltOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Kilt Of Evolution (" + mEvolutionPoints.ToString() + ")";
