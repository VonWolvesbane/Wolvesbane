//Heater GargishWingArmor Of Evolution By: Sean (http://www.wftpradio.net/)
...
{
	public class GargishWingArmorOfEvolution: GargishLeatherWingArmor
	{
		...
		[Constructable]
		public GargishWingArmorOfEvolution()
		{	Name = "Gargish Wing Armor Of Evolution";
			Hue = 2177;

            ArmorAttributes.SelfRepair = 10;
        }

        public GargishWingArmorOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Gargish Wing Armor Of Evolution (" + mEvolutionPoints.ToString() + ")";
