//Dragon Gorget Of Evolution By: Sean (http://www.wftpradio.net/)
...
{
	public class DragonGorgetOfEvolution: PlateGorget
	{
		...
		[Constructable]
		public DragonGorgetOfEvolution()
		{	Name = "Dragon Gorget Of Evolution";
			Hue = 1911;

            ArmorAttributes.SelfRepair = 10;
        }

        public DragonGorgetOfEvolution(Serial serial)
            : base(serial)
        {
        }
        ...
        public void ApplyGain()
        {
            ...
            {
                mEvolutionPoints++;
                this.Name = "Dragon Gorget Of Evolution (" + mEvolutionPoints.ToString() + ")";
