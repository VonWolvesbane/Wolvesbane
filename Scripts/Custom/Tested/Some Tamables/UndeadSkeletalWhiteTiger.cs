...
{
	[CorpseName( "an Undead Skeletal White Tiger corpse" )]
	public class UndeadSkeletalWhiteTiger : AncientWyrm
	{
		[Constructable]
		public UndeadSkeletalWhiteTiger()
		{
			this.Name = "Undead Skeletal White Tiger";
			this.Body = 1441;
			this.BaseSoundID = 0;
		...
		public override void GenerateLoot()
		{
			...
			Name = "Undead Skeletal White Tiger";
			Hue = 1150;
			SetStr( 1096, 1185 );
			SetDex( 155, 175 );
			SetInt( 686, 775 );
		...
		public UndeadSkeletalWhiteTiger( Serial serial ) : base( serial )
		{
		}
