...
//This script was created on 4/17/2019 1:40:19 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Dragon Serpent corpse" )]
	public class DragonSerpent : WhiteWyrm
	{
		[Constructable]
		public DragonSerpent()
		{
			this.Body = 150;
            this.Name = "Dragon Serpent";
		...
		public DragonSerpent( Serial serial ) : base( serial )
		{
		}
