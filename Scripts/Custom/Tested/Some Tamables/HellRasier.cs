...
//This script was created on 4/17/2019 3:58:19 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Hell Rasier corpse" )]
	public class HellRasier : WhiteWyrm
	{
		[Constructable]
		public HellRasier()
		{
			this.Name = "Hell Rasier";
			this.Body = 1433;
		...
		public HellRasier( Serial serial ) : base( serial )
		{
		}
