...
//This script was created on 4/17/2019 4:50:39 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Eternal One corpse" )]
	public class EternalOne : WhiteWyrm
	{
		[Constructable]
		public EternalOne()
		{
			this.Name = "Eternal One";
			this.Body = 1420;
		...
		public EternalOne( Serial serial ) : base( serial )
		{
		}
