...
//This script was created on 4/17/2019 8:24:24 AM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Wild Turkey corpse" )]
	public class AWildTurkey : Nightmare
	{
		[Constructable]
		public AWildTurkey()
		{
			this.Name = "Wild Turkey";
			this.Body = 1026;
			//this.hue = 0;
			//this.BaseSoundId = 0;
		...
		public AWildTurkey( Serial serial ) : base( serial )
		{
		}
