...
//This script was created on 4/17/2019 12:53:32 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an A Palomino Pony corpse" )]
	public class APalominoPony : Nightmare
	{
		[Constructable]
		public APalominoPony()
		{
			Name = "A Palomino Pony"; 
		...
		public APalominoPony( Serial serial ) : base( serial )
		{
		}
