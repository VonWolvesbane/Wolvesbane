...
//This script was created on 4/17/2019 1:26:57 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Keep on Rollin corpse" )]
	public class KeeponRollin : AncientWyrm
	{
		[Constructable]
		public KeeponRollin()
		{
			this.Name = "Keep on Rollin";
			this.Body = 1431;
		...
		public KeeponRollin( Serial serial ) : base( serial )
		{
		}
