...
//This script was created on 4/17/2019 5:22:41 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Braveheart corpse" )]
	public class Braveheart : WhiteWyrm
	{
		[Constructable]
		public Braveheart()
		{
			this.Name = "Braveheart";
			this.Body = 1422;
		...
		public Braveheart( Serial serial ) : base( serial )
		{
		}
