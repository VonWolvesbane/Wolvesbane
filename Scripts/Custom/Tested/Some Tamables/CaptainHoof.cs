...
//This script was created on 4/17/2019 12:42:49 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Captain Hoof corpse" )]
	public class CaptainHoof : WhiteWyrm
	{
		[Constructable]
		public CaptainHoof()
		{
			this.Name = "Captain Hoof";
			this.Body = 1425;
		...
		public CaptainHoof( Serial serial ) : base( serial )
		{
		}
