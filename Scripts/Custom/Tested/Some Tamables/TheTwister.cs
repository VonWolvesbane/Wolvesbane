...
//This script was created on 4/16/2019 9:17:54 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an The Twister corpse" )]
	public class TheTwister : WhiteWyrm
	{
		[Constructable]
		public TheTwister()
		{
			this.Name = "The Twister";
			this.Body = 1432;
			this.BaseSoundID = 0;
		...
		public TheTwister( Serial serial ) : base( serial )
		{
		}
