...
//This script was created on 4/17/2019 1:45:41 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an The Tribal Chief corpse" )]
	public class TheTribalChief : AncientWyrm
	{
		[Constructable]
		public TheTribalChief()
		{
			this.Name = "The Tribal Chief";
			this.Body = 1479;
		...
		public TheTribalChief( Serial serial ) : base( serial )
		{
		}
