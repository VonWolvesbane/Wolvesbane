...
//This script was created on 4/17/2019 4:12:36 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Aztec Bio Engineer corpse" )]
	public class AztecBioEngineer : WhiteWyrm
	{
		[Constructable]
		public AztecBioEngineer()
		{
			this.Name = "Aztec Bio Engineer";
			this.Body = 1406;
		...
		public AztecBioEngineer( Serial serial ) : base( serial )
		{
		}
