...
//This script was created on 4/17/2019 5:08:56 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Lord of the Skys corpse" )]
	public class LordoftheSkys : WhiteWyrm
	{
		[Constructable]
		public LordoftheSkys()
		{
			this.Name = "Lord of the Skys";
			this.Body = 1434;
		...
		public LordoftheSkys( Serial serial ) : base( serial )
		{
		}
