...
//This script was created on 4/17/2019 5:03:11 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an Platinum Dragon corpse" )]
	public class PlatinumDragon : WhiteWyrm
	{
		[Constructable]
		public PlatinumDragon()
		{
			this.Name = "Platinum Dragon";
			this.Body = 1417;
