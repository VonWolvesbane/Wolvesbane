...
//This script was created on 4/17/2019 4:43:55 PM
//=================================================
using System;
using Server;
using Server.Items;
...
{
	[CorpseName( "an The Dragon Lord corpse" )]
	public class TheDragonLord : WhiteWyrm
	{
		[Constructable]
		public TheDragonLord()
		{
			this.Name = "The Dragon Lord";
			this.Body = 1419;
		...
		public TheDragonLord( Serial serial ) : base( serial )
		{
		}
