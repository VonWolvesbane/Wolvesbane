...
namespace Server.Mobiles
{
	...
	public class RainbowChargerOfTheFallen : BaseMount
	{
        ...
        [Constructable]
		public RainbowChargerOfTheFallen() : this( "a rainbow charger of the fallen" )
		{
		}

		[Constructable]
		public RainbowChargerOfTheFallen( string name ) : base( name, 0x2D9C, 0x3E92, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public RainbowChargerOfTheFallen( Serial serial ) : base( serial )
		{
		}
