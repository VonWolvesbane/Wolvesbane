...
namespace Server.Mobiles
{
	...
	public class RainbowScaledSwampDragon : BaseMount
	{
        ...
        [Constructable]
		public RainbowScaledSwampDragon() : this( "a rainbow scaled swamp dragon" )
		{
		}

		[Constructable]
		public RainbowScaledSwampDragon( string name ) : base( name, 0xE2, 0x3EA0, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public RainbowScaledSwampDragon( Serial serial ) : base( serial )
		{
		}
