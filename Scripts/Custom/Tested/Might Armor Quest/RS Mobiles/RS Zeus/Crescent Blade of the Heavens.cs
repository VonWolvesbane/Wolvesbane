...
{
	public class CrescentBladeoftheHeavens : CrescentBlade
  {
public override int ArtifactRarity{ get{ return 666; } }
      ...
      [Constructable]
		public CrescentBladeoftheHeavens()
		{
          Name = "Crescent Blade of the Heavens";
	  Hue = 2248;
      ...
      Attributes.BonusMana = 10;
		...
		public CrescentBladeoftheHeavens( Serial serial ) : base( serial )
		{
		}
