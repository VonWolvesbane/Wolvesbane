...
namespace Server.Mobiles
{
	...
	public class VeriteColossus : BaseCreature
	{
		[Constructable]
		public VeriteColossus() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a verite colossus";
			Body = 0x33D;
			Hue = 0x89F;
			BaseSoundID = 268;
		...
		public override void OnDeath( Container c )
		{
			...
			VeriteGranite granite = new VeriteGranite();
   			granite.Amount = 10;
   			c.DropItem(granite);
		...
		public VeriteColossus( Serial serial ) : base( serial )
		{
		}
