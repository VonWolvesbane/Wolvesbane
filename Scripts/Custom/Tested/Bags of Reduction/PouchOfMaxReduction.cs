...
namespace Server.Items {
	public class PouchOfReduction : Pouch {
		...
		public override string DefaultName { get { return "Pouch of Weight Reduction"; } }
		[Constructable]
		public PouchOfReduction() : this(100) {}
		[Constructable]
		public PouchOfReduction(int redux) : base() {
			ReduxPercent=redux;
		}
		public PouchOfReduction(Serial serial) : base(serial) {}
