...
{
	public class BonusManaRune : Item
	{
		[Constructable]
		public BonusManaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Bonus Mana Rune";
			Hue = 2101;
		}
		...
		{
			private BonusManaRune m_BonusManaRune;

			public InternalTarget( BonusManaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_BonusManaRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{							
							Weapon.Attributes.BonusMana += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.Attributes.BonusMana += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.Attributes.BonusMana += augment; 
