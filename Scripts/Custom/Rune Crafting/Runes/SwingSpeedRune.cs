...
{
	public class SwingSpeedRune : Item
	{
		[Constructable]
		public SwingSpeedRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Swing Speed Increase Rune";
			Hue = 2584;
		}
		...
		{
			private SwingSpeedRune m_SwingSpeedRune;

			public InternalTarget( SwingSpeedRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_SwingSpeedRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.Attributes.WeaponSpeed += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.Attributes.WeaponSpeed += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Clothing.Attributes.WeaponSpeed += augmentper; 
