...
{
	public class ResistFireRune : Item
	{
		[Constructable]
		public ResistFireRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Resist Fire Bonus Rune";
			Hue = 1416;
		}
		...
		{
			private ResistFireRune m_ResistFireRune;

			public InternalTarget( ResistFireRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ResistFireRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.ResistFireBonus += augmentper; 
		...
		public ResistFireRune( Serial serial ) : base( serial )
		{
		}
