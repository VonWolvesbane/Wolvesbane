...
{
	public class LowerManaCostRune : Item
	{
		[Constructable]
		public LowerManaCostRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Lower Mana Cost Rune";
			Hue = 1266;
		}
		...
		{
			private LowerManaCostRune m_LowerManaCostRune;

			public InternalTarget( LowerManaCostRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_LowerManaCostRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.Attributes.LowerManaCost += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_LowerManaCostRune.Delete();
			          		}
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.Attributes.LowerManaCost += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.Attributes.LowerManaCost += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Clothing.Attributes.LowerManaCost += augmentper; 
		...
		public LowerManaCostRune( Serial serial ) : base( serial )
		{
		}
