...
{
	public class HitLeechManaRune : Item
	{
		[Constructable]
		public HitLeechManaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Leech Mana Rune";
			Hue = 2075;
		}
		...
		{
			private HitLeechManaRune m_HitLeechManaRune;

			public InternalTarget( HitLeechManaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitLeechManaRune = runeaug;
			}
