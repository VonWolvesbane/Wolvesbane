...
{
	public class UseBestWepRune : Item
	{
		[Constructable]
		public UseBestWepRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Use Best Weapon Skill Rune";
			Hue = 999;
		}
		...
		{
			private UseBestWepRune m_UseBestWepRune;

			public InternalTarget( UseBestWepRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_UseBestWepRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						{
							Weapon.WeaponAttributes.UseBestSkill += augmentper;
							from.SendMessage( "TheDurability Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_UseBestWepRune.Delete();
			          		}
		...
		//	list.Add( "Use best Weapon Skill" );
		//}
	}
}