...
{
	public class HitPoisonAreaRune : Item
	{
		[Constructable]
		public HitPoisonAreaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Poison Area Rune";
			Hue = 1359;
		}
		...
		{
			private HitPoisonAreaRune m_HitPoisonAreaRune;

			public InternalTarget( HitPoisonAreaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitPoisonAreaRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitPoisonArea += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitPoisonAreaRune.Delete();
			          		}
		...
		public HitPoisonAreaRune( Serial serial ) : base( serial )
		{
		}
