...
namespace Server.Items
{
	...
	{
		[Constructable]
		public DemonSlayer() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Reptile Slayer";
			Hue = 2727;
		...
		{
			private DemonSlayer m_DemonSlayer;

			public InternalTarget( DemonSlayer runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_DemonSlayer = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					else if ( Weapon.Slayer == SlayerName.Exorcism || Weapon.Slayer2 == SlayerName.Exorcism )
					{
						...
						{
							Weapon.Slayer = SlayerName.Exorcism; from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_DemonSlayer.Delete();
			          		}
						else if( Weapon.Slayer2 == SlayerName.None )
						{
							Weapon.Slayer2 = SlayerName.Exorcism; from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_DemonSlayer.Delete();
			          		}
					      }
		...
		public DemonSlayer( Serial serial ) : base( serial )
		{
		}
