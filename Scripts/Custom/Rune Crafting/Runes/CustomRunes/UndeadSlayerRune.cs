...
{
	public class UndeadSlayer : Item
	{
		[Constructable]
		public UndeadSlayer() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Undead Slayer";
			Hue = 2727;
		...
		{
			private UndeadSlayer m_UndeadSlayer;

			public InternalTarget( UndeadSlayer runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_UndeadSlayer = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					else if ( Weapon.Slayer == SlayerName.Silver || Weapon.Slayer2 == SlayerName.Silver )
					{
		...
		public UndeadSlayer( Serial serial ) : base( serial )
		{
		}
