...
{
	public class ElementalSlayer : Item
	{
		[Constructable]
		public ElementalSlayer() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
		...
		{
			private ElementalSlayer m_ElementalSlayer;

			public InternalTarget( ElementalSlayer runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ElementalSlayer = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					else if ( Weapon.Slayer == SlayerName.ElementalBan || Weapon.Slayer2 == SlayerName.ElementalBan )
					{
						from.SendMessage( "That Weapon already has This Slayer Type!");
					}
						...
						{
							Weapon.Slayer = SlayerName.ElementalBan; from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_ElementalSlayer.Delete();
			          		}
						else if( Weapon.Slayer2 == SlayerName.None )
						{
							Weapon.Slayer2 = SlayerName.ElementalBan; from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_ElementalSlayer.Delete();
			          		}
					      }
		...
		public ElementalSlayer( Serial serial ) : base( serial )
		{
		}
