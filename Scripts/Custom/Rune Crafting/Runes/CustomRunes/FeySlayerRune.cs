...
{
	public class FeySlayer : Item
	{
		[Constructable]
		public FeySlayer() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Fey Slayer";
			Hue = 2727;
		...
		{
			private FeySlayer m_FeySlayer;

			public InternalTarget( FeySlayer runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_FeySlayer = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					else if ( Weapon.Slayer == SlayerName.Fey || Weapon.Slayer2 == SlayerName.Fey )
					{
						...
						{
							Weapon.Slayer = SlayerName.Fey; from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_FeySlayer.Delete();
			          		}
						else if( Weapon.Slayer2 == SlayerName.None )
						{
							Weapon.Slayer2 = SlayerName.Fey; from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_FeySlayer.Delete();
			          		}
					      }
		...
		public FeySlayer( Serial serial ) : base( serial )
		{
		}
