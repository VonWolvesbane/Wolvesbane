...
{
	public class ResistEnergyRune : Item
	{
		[Constructable]
		public ResistEnergyRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Resist Energy Bonus Rune";
			Hue = 1416;
		}
		...
		public ResistEnergyRune( Serial serial ) : base( serial )
		{
		}
