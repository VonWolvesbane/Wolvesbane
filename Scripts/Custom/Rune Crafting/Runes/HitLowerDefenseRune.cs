...
{
	public class HitLowerDefenseRune : Item
	{
		[Constructable]
		public HitLowerDefenseRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Lower Defense Rune";
			Hue = 1779;
		}
		...
		{
			private HitLowerDefenseRune m_HitLowerDefenseRune;

			public InternalTarget( HitLowerDefenseRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitLowerDefenseRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitLowerDefend += augmentper; 
		...
		public HitLowerDefenseRune( Serial serial ) : base( serial )
		{
		}
