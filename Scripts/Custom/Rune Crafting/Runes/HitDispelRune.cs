...
{
	public class HitDispelRune : Item
	{
		[Constructable]
		public HitDispelRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Dispel Rune";
			Hue = 294;
		}
		...
		{
			private HitDispelRune m_HitDispelRune;

			public InternalTarget( HitDispelRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitDispelRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						{
							Weapon.WeaponAttributes.HitDispel += augmentper;
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitDispelRune.Delete();
			          		}
		...
		public HitDispelRune( Serial serial ) : base( serial )
		{
		}
