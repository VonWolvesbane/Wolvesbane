...
{
	public class HitMagicArrowRune : Item
	{
		[Constructable]
		public HitMagicArrowRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Magic Arrow Rune";
			Hue = 294;
		}
		...
		{
			private HitMagicArrowRune m_HitMagicArrowRune;

			public InternalTarget( HitMagicArrowRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitMagicArrowRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitMagicArrow += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitMagicArrowRune.Delete();
			          		}
		...
		public HitMagicArrowRune( Serial serial ) : base( serial )
		{
		}
