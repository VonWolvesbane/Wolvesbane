...
{
	public class HitHarmRune : Item
	{
		[Constructable]
		public HitHarmRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Harm Rune";
			Hue = 294;
		...
		{
			private HitHarmRune m_HitHarmRune;

			public InternalTarget( HitHarmRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitHarmRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitHarm += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitHarmRune.Delete();
			          		}
