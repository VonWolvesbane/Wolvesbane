...
{
	public class HitPhysAreaRune : Item
	{
		[Constructable]
		public HitPhysAreaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Physical Area Rune";
			Hue = 1359;
		}
		...
		{
			private HitPhysAreaRune m_HitPhysAreaRune;

			public InternalTarget( HitPhysAreaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitPhysAreaRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitPhysicalArea += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitPhysAreaRune.Delete();
			          		}
		...
		public HitPhysAreaRune( Serial serial ) : base( serial )
		{
		}
