...
{
	public class RegenManaRune : Item
	{
		[Constructable]
		public RegenManaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Regen Mana Rune";
			Hue = 1710;
		}
		...
		{
			private RegenManaRune m_RegenManaRune;

			public InternalTarget( RegenManaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_RegenManaRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{						
							Weapon.Attributes.RegenMana += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.Attributes.RegenMana += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Clothing.Attributes.RegenMana += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Jewel.Attributes.RegenMana+= augment; 
