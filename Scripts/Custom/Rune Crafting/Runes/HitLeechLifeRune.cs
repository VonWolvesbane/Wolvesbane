...
{
	public class HitLeechLifeRune : Item
	{
		[Constructable]
		public HitLeechLifeRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Leech Life Rune";
			Hue = 2075;
		}
		...
		{
			private HitLeechLifeRune m_HitLeechLifeRune;

			public InternalTarget( HitLeechLifeRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitLeechLifeRune = runeaug;
			}
