...
{
	public class HitLeechStamRune : Item
	{
		[Constructable]
		public HitLeechStamRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Leech Stam Rune";
			Hue = 2075;
		}
		...
		{
			private HitLeechStamRune m_HitLeechStamRune;

			public InternalTarget( HitLeechStamRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitLeechStamRune = runeaug;
			}
		...
		public HitLeechStamRune( Serial serial ) : base( serial )
		{
		}
