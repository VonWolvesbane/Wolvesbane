...
{
	public class RegenHitsRune : Item
	{
		[Constructable]
		public RegenHitsRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Point Regen Rune";
			Hue = 1710;
		}
		...
		{
			private RegenHitsRune m_RegenHitsRune;

			public InternalTarget( RegenHitsRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_RegenHitsRune = runeaug;
			}
