...
{
	public class HitColdAreaRune : Item
	{
		[Constructable]
		public HitColdAreaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Cold Area Rune";
			Hue = 1359;
		}
		...
		{
			private HitColdAreaRune m_HitColdAreaRune;

			public InternalTarget( HitColdAreaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitColdAreaRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitColdArea += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitColdAreaRune.Delete();
			          		}
		...
		public HitColdAreaRune( Serial serial ) : base( serial )
		{
		}
