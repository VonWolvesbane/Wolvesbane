...
{
	public class HitFireAreaRune : Item
	{
		[Constructable]
		public HitFireAreaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Fire Area Rune";
			Hue = 1359;
		}
		...
		{
			private HitFireAreaRune m_HitFireAreaRune;

			public InternalTarget( HitFireAreaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitFireAreaRune = runeaug;
			}
