...
{
	public class HitLightningRune : Item
	{
		[Constructable]
		public HitLightningRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Lightning Rune";
			Hue = 294;
		}
		...
		{
			private HitLightningRune m_HitLightningRune;

			public InternalTarget( HitLightningRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitLightningRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitLightning += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitLightningRune.Delete();
			          		}
		...
		public HitLightningRune( Serial serial ) : base( serial )
		{
		}
