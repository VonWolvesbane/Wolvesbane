...
{
	public class ResistPhysRune : Item
	{
		[Constructable]
		public ResistPhysRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Resist Physical Bonus Rune";
			Hue = 1416;
		}
		...
		{
			private ResistPhysRune m_ResistPhysRune;

			public InternalTarget( ResistPhysRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ResistPhysRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.ResistPhysicalBonus += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_ResistPhysRune.Delete();
			          		}
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.PhysicalBonus += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.PhysicalBonus += augmentper; 
		...
		public ResistPhysRune( Serial serial ) : base( serial )
		{
		}
