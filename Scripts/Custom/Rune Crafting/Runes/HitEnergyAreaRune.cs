...
{
	public class HitEnergyAreaRune : Item
	{
		[Constructable]
		public HitEnergyAreaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hit Energy Area Rune";
			Hue = 1359;
		}
		...
		{
			private HitEnergyAreaRune m_HitEnergyAreaRune;

			public InternalTarget( HitEnergyAreaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HitEnergyAreaRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{
							Weapon.WeaponAttributes.HitEnergyArea += augmentper; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_HitEnergyAreaRune.Delete();
			          		}
		...
		public HitEnergyAreaRune( Serial serial ) : base( serial )
		{
		}
