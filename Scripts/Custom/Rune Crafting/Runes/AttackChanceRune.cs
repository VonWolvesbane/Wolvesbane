...
{
	public class AttackChanceRune : Item
	{
		[Constructable]
		public AttackChanceRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Attack Chance Increase Rune";
			Hue = 2584;
		}
		...
		{
			private AttackChanceRune m_AttackChanceRune;

			public InternalTarget( AttackChanceRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_AttackChanceRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.Attributes.AttackChance += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.Attributes.AttackChance += augmentper; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Clothing.Attributes.AttackChance += augmentper; 
