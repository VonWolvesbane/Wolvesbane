...
{
	public class SelfRepairRune : Item
	{
		[Constructable]
		public SelfRepairRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Self Repair Rune";
			Hue = 2584;
		}
		...
		{
			private SelfRepairRune m_SelfRepairRune;

			public InternalTarget( SelfRepairRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_SelfRepairRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{						
							Weapon.WeaponAttributes.SelfRepair += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.ArmorAttributes.SelfRepair += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.ArmorAttributes.SelfRepair += augment; 
