...
{
	public class BonusDexRune : Item
	{
		[Constructable]
		public BonusDexRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Bonus Dex Rune";
			Hue = 2101;
		...
		{
			private BonusDexRune m_BonusDexRune;

			public InternalTarget( BonusDexRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_BonusDexRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
						...
						{						
							Weapon.Attributes.BonusDex += augment; 
							from.SendMessage( "The Rune enhances your weapon." );
				                  	from.PlaySound( 0x1F5 );
			        	          	m_BonusDexRune.Delete();
			          		}
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Armor.Attributes.BonusDex += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Shield.Attributes.BonusDex += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Clothing.Attributes.BonusDex += augment; 
				...
				{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							Jewel.Attributes.BonusDex += augment; 
