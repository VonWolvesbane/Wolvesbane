...
{
    // Split from Wolvesbane_Gargoyle_Gear_v3.cs: ObsidianWingLegs

    public class ObsidianWingLegs : GargishPlateLegs
    {
        ...
        [Constructable]
        public ObsidianWingLegs() { Name = "Obsidian Wing Leggings"; Hue = 1175; Setup(); }
        ...
        public ObsidianWingLegs(Serial s) : base(s) { }
