...
{
    // Split from Wolvesbane_Gargoyle_Gear_v3.cs: ObsidianWingKilt

    public class ObsidianWingKilt : GargishPlateKilt
    {
        ...
        [Constructable]
        public ObsidianWingKilt() { Name = "Obsidian Wing Kilt"; Hue = 1175; Setup(); }
        ...
        public ObsidianWingKilt(Serial s) : base(s) { }
