...
{
    // Split from Wolvesbane_Gargoyle_Gear_v3.cs: AeternumStoneArms

    public class AeternumStoneArms : GargishPlateArms
    {
        ...
        [Constructable]
        public AeternumStoneArms() { Name = "Aeternum Stone Arms"; Hue = 2406; Setup(); }
        ...
        public AeternumStoneArms(Serial s) : base(s) { }
