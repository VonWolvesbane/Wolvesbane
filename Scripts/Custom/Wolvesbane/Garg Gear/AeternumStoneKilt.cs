...
{
    // Split from Wolvesbane_Gargoyle_Gear_v3.cs: AeternumStoneKilt

    public class AeternumStoneKilt : GargishPlateKilt
    {
        ...
        [Constructable]
        public AeternumStoneKilt() { Name = "Aeternum Stone Kilt"; Hue = 2406; Setup(); }
        ...
        public AeternumStoneKilt(Serial s) : base(s) { }
