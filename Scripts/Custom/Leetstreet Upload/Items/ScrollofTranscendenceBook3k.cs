...
namespace Server.Items
{
    ...
    public class TranscendenceBook3k : BaseSpecialScrollBook
    {
        public const int MaxScrolls3k = 3000;

        public override Type ScrollType { get { return typeof(ScrollOfTranscendence); } }
        public override int LabelNumber { get { return 1151679; } }
        public override int BadDropMessage { get { return 1151677; } }
        public override int DropMessage { get { return 1151674; } } 
        public override int RemoveMessage { get { return 1151658; } }
        public override int GumpTitle { get { return 1151675; } }

        [Constructable]
        public TranscendenceBook3k()
            : base(0x577E)
        {
            Hue = 0x490;
            Capacity = MaxScrolls3k;
            Name = "SOTB3K";
        }

        public TranscendenceBook3k(Serial serial)
            : base(serial)
        {
        }
