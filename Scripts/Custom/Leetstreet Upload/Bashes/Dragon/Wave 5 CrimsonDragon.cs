...
{
    [CorpseName("a tele dragon corpse")]
    public class TeleDragon : BasePeerless
    {
        ...
        [Constructable]
        public TeleDragon()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.01, 0.4)
        {
            this.Name = "You Scared?";
            this.Body = 197;
            this.Hue = Utility.RandomBool() ? 2400 : 2801;
            ...
            this.SetHits(2500000);
            this.SetStam(2500000);
            ...
            this.SetSkill(SkillName.Necromancy, 400);
            this.SetSkill(SkillName.SpiritSpeak, 400);
            this.SetSkill(SkillName.MagicResist, 200);
            this.SetSkill(SkillName.Tactics, 200);
            this.SetSkill(SkillName.Wrestling, 500);
            this.SetSkill(SkillName.Anatomy, 500);
        ...
        public TeleDragon(Serial serial)
            : base(serial)
        {
        }
