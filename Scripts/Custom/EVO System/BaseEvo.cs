...
namespace Xanthos.Evo
{
	...
	{
		private static double kOverLimitLossChance = 0.05;	// Chance that loyalty will be lost if over followers limit
		...
		public BaseEvo( string name, int bodyID, int itemID ) : base(name, bodyID, itemID, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.4, 0.1 )
		{
			Name = name;
			Init();
			InitAI();
