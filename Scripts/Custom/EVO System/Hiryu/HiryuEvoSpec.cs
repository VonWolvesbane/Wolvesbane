...
namespace Xanthos.Evo
{
	public sealed class HiryuEvoSpec : BaseEvoSpec
	{
		...
		HiryuEvoSpec()
		{
			...
			m_PercentFemaleChance = 0.3;
			m_GuardianEggOrDeedChance = 0.1;
			m_AlwaysHappy = false;
			...
			m_MaxSkillValues = new int[4] { 150, 150, 150, 150 };
	...
	public class HiryuStageOne : BaseEvoStage
	{
		public HiryuStageOne()
		{
			...
			DamageMin = 15; DamageMax = 19; HitsMin = 150; HitsMax = 200;
	...
	public class HiryuStageTwo : BaseEvoStage
	{
		public HiryuStageTwo()
		{
			...
			DamageMin = 5; DamageMax = 11; HitsMin= 450; HitsMax = 450;
	...
	public class HiryuStageThree : BaseEvoStage
	{
		public HiryuStageThree()
		{
			...
			DamageMin = 10; DamageMax = 10; HitsMin= 100; HitsMax = 100;
	...
	public class HiryuStageFour : BaseEvoStage
	{
		public HiryuStageFour()
		{
			...
			DamageMin = 25; DamageMax = 25; HitsMin= 600; HitsMax = 600;
			StrMin = 250; StrMax = 250; DexMin = 90; DexMax = 90; IntMin = 300; IntMax = 300;
		}
	}
	...
	public class HiryuStageFive : BaseEvoStage
	{
		public HiryuStageFive()
		{
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 92, 92, 92, 92, 92 };
			MaxResistances = new int[5] { 92, 92, 92, 92, 92 };	

			DamageMin = 50; DamageMax = 50; HitsMin= 1000; HitsMax = 1000;
			StrMin = 800; StrMax = 800; DexMin = 90; DexMax = 90; IntMin = 200; IntMax = 200;
		}
	}
}