...
{
	[CorpseName( "a guardian Deamon corpse" )]
	public class GuardianDeamon : EvoDeamon, IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
		public GuardianDeamon() : base( "A Guardian Deamon" )
		{
		}

		public GuardianDeamon( Serial serial ) : base( serial )
		{
		}
