		...
		if (args.Mobile.AccessLevel < AccessLevel.GameMaster) 
		{
            switch (Utility.Random(6))
            {
                case 0:
                    ...
                    World.Broadcast(0x40, true, "Death to {0} May Von Wolvesbane have mercy on your soul.", args.Mobile.Name);
                    break;
			    ...
			    case 3:
                    ...
                    case 4:
                        args.Mobile.PlaySound(256);
                        World.Broadcast(0x40, true, "{0} Fought the Staff, but the Staff has a [kill button!", args.Mobile.Name);
                        break;
                    case 5:
                        args.Mobile.PlaySound(256);
                        World.Broadcast(0x40, true, "{0} Tripped and Died trying to Duck a Flying Table from Lady J!", args.Mobile.Name);
                        break;
                }
		}
		}
