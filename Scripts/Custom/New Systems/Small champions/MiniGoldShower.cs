...
{
	public class MiniGoldShower
	{
		public static void DoForChamp(Point3D center, Map map)
		{
			Do(center, map, MiniChampionSystem.MiniGoldShowerPiles, MiniChampionSystem.MiniGoldShowerMinAmount, MiniChampionSystem.MiniGoldShowerMaxAmount);
		}
		public static void DoForHarrower(Point3D center, Map map)
		{
			Do(center, map, MiniChampionSystem.HarrowerMiniGoldShowerPiles, MiniChampionSystem.HarrowerMiniGoldShowerMinAmount, MiniChampionSystem.HarrowerMiniGoldShowerMaxAmount);
		}
