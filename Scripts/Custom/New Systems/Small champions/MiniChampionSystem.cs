...
{
	public class MiniChampionSystem
	{
		private static bool m_Enabled = false;
		private static bool m_Initialized = false;
		private static readonly string m_Path = Path.Combine("Saves", "Champions", "MiniChampionSystem.bin");
		...
		private static int m_MiniGoldShowerPiles;
		private static int m_MiniGoldShowerMinAmount;
		private static int m_MiniGoldShowerMaxAmount;
		...
		public static int MiniGoldShowerPiles { get { return m_MiniGoldShowerPiles; } }
		public static int MiniGoldShowerMinAmount { get { return m_MiniGoldShowerMinAmount; } }
		public static int MiniGoldShowerMaxAmount { get { return m_MiniGoldShowerMaxAmount; } }
		public static int HarrowerMiniGoldShowerPiles { get { return m_HarrowerGoldPiles; } }
		public static int HarrowerMiniGoldShowerMinAmount { get { return m_HarrowerGoldMinAmount; } }
		public static int HarrowerMiniGoldShowerMaxAmount { get { return m_HarrowerGoldMaxAmount; } }
		...
		public static void Configure()
		{
			...
			m_MiniGoldShowerPiles = Config.Get("Champions.GoldPiles", 30);
			m_MiniGoldShowerMinAmount = Config.Get("Champions.GoldMin", 100);
			m_MiniGoldShowerMaxAmount = Config.Get("Champions.GoldMax", 350);
			m_HarrowerGoldPiles = Config.Get("Champions.HarrowerGoldPiles", 75);
			m_HarrowerGoldMinAmount = Config.Get("Champions.HarrowerGoldMin", 300);
			m_HarrowerGoldMaxAmount = Config.Get("Champions.HarrowerGoldMax", 5000);
			m_PowerScrollAmount = Config.Get("Champions.PowerScrolls", 1);
			m_StatScrollAmount = Config.Get("Champions.StatScrolls", 2);
			...
			m_MaxKill[0] = Config.Get("Champions.Rank1MaxKills", 100);
			m_MaxKill[1] = Config.Get("Champions.Rank2MaxKills", 50);
