...
namespace Server.Mobiles
{
	public class EvilDruidLord : BaseCreature
	{
		...
		public EvilDruidLord() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            ...
            AddItem(new ACC.CSS.Systems.Druid.DruidSpellbook());
        ...
        public override void OnDeath(Container c)
        {
            ...
            {
                case 0: c.DropItem(new PetBondingDeed()); break;
                case 1: c.DropItem(new PetMaxLevelDeed()); break;
                case 2: c.DropItem(new InstaTameDeed()); break;
                case 3: c.DropItem(new BlackDyeTub()); break;
                case 4: c.DropItem(new ACC.CSS.Systems.Druid.DruidSpellbook()); break;
            }
