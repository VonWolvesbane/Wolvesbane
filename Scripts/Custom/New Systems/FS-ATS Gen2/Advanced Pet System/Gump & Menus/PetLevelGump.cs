...
namespace Server.Gumps
{
	public class PetLevelGump : Gump
	{
		...
		public PetLevelGump( Mobile pet ) : base( 0, 0 )
		{
			...
			if ( bc.Level > 35 )
			{
				AddLabel(60, 175, 38, @"100 Ability Points Required per ability");
				
				AddLabel(60, 200, 1149, @"Repel");
				if ( bc.HasAbility(SpecialAbility.Repel))
				{
				AddLabel(330, 200, 1149, @"Learned");//extra
				}
				else
				{
				...
				AddLabel(60, 225, 1149, @"Poison Attack");
				if ( bc.HasAbility(SpecialAbility.VenomousBite))
				{
				AddLabel(330, 225, 1149, @"Learned");//extra
				}
				else
				{
				...
				AddLabel(60, 250, 1149, @"Fire Breath Attack");
				if ( bc.HasAbility(SpecialAbility.DragonBreath))
				{
				AddLabel(330, 250, 1149, @"Learned");//extra
				}
				else
				{
			...
			if ( bc.Level > 45 )
			{
				AddLabel(60, 300, 38, @"250 Ability Points Required per ability");
				
				AddLabel(60, 325, 1149, @"Heal"); //extra
				if ( bc.HasAbility(SpecialAbility.Heal))
				{
				AddLabel(330, 325, 1149, @"Learned");//extra
				}
				else
				{
				...
				AddLabel(60, 350, 1149, @"Colossal Rage"); //extra
				...
				AddLabel(60, 375, 1149, @"Howl Of Cacophony"); //extra
				if ( bc.HasAbility(SpecialAbility.HowlOfCacophony))
				{
				AddLabel(330, 375, 1149, @"Learned");//extra
				}
				else
				{
