	...
	public class BreedingAcceptGump : Gump
	{
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if ( info.ButtonID == 2 )
			{
				...
				int babyMlev = newMlev + Utility.RandomMinMax( 2, 4 );
				...
				else
				{
					if ( cm1 != null && cm2 != null )
					{
						...
						bc1.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours( 6.0 );
						bc2.MatingDelay = DateTime.UtcNow + TimeSpan.FromHours( 6.0 );
					}
				}
			}
