...
namespace Server.Items
{
    ...
    public class SmallBagofHolding : WeightReductionContainer
    {
		...
		public override double WeightReductionAmount => 1.0;

		// Do not display the weight redution in the item properties
		public override bool DisplayWeightReductionProperty => false;

		// Limit the maximum items
		public override int ContainerMaxItems => 5;
    ...
    public abstract class WeightReductionContainer : Container
    {
        ...
        public virtual TimeSpan AccessDelay { get { return TimeSpan.FromMinutes(0.0); } }
