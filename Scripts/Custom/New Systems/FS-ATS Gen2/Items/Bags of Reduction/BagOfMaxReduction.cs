...
namespace Server.Items {
	public class BagOfReduction : Bag {
		...
		public override string DefaultName { get { return "Bag of Weight Reduction"; } }
		[Constructable]
		public BagOfReduction() : this(100) {}
		[Constructable]
		public BagOfReduction(int redux) : base() {
			ReduxPercent=redux;
		}
		public BagOfReduction(Serial serial) : base(serial) {}
