...
{
	public class GreaterCurePotionPet : BasePotion
	{

		[Constructable]
		public GreaterCurePotionPet() : base( 0x182B, PotionEffect.PetGreaterCure )
		{
			Weight = 1.0;
			Movable = true;
		...
		public GreaterCurePotionPet( Serial serial ) : base( serial )
		{
		}
		...
		public override void Drink( Mobile m )
		{
			if ( !IsChildOf( m.Backpack ) )
			{
		        ...
		        {
				m.Target = new GreaterCurePotionPetTarget( this );
  		...
  		private class GreaterCurePotionPetTarget : Target 
      		{ 
         		private Mobile m_Owner; 
      
         		private GreaterCurePotionPet m_Powder; 

         		public GreaterCurePotionPetTarget( GreaterCurePotionPet charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder=charge; 
         		} 
