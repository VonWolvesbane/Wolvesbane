...
{
	public class NewHitchingPostEast : AddonComponent
	{
		private int m_Charges;
		private NewHitchingPostEastAddon m_Addon;
		...
		#region Constructors
		[Constructable]
		public NewHitchingPostEast() : this( 0x14E7 )
		{
		}

		[Constructable]
		public NewHitchingPostEast( NewHitchingPostEastAddon addon, int charges, int itemID ) : base( itemID )
		{
			m_Charges = charges;
			m_Addon = addon;
		}
		
		public NewHitchingPostEast( Serial serial ) : base( serial )
		{
		}
		#endregion
		...
		private class HitchingPostTarget : Target 
      		{ 
         		...
         		private NewHitchingPostEast m_Powder;
			private NewHitchingPostEastAddon m_Addon; 

         		public HitchingPostTarget( NewHitchingPostEastAddon addon, NewHitchingPostEast charge ) : base ( 10, false, TargetFlags.None ) 
         		{ 
            			m_Powder = charge;
				m_Addon = addon;
         		} 
	...
	public class NewHitchingPostEastAddon : BaseAddon
	{
		...
		public override BaseAddonDeed Deed{ get{ return new NewHitchingPostEastDeed( m_Charges ); } }

		[Constructable]
		public NewHitchingPostEastAddon( int charges)
		{
			Charges = charges;
			AddComponent( new NewHitchingPostEast( this, m_Charges, 0x14E7 ), 0, 0, 0 );
		}

		public NewHitchingPostEastAddon( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddon Addon{ get{ return new NewHitchingPostEastAddon( m_Charges ); } }
		...
		[Constructable]
		public NewHitchingPostEastDeed() : this( 100 )
		{
		}
		...
		public NewHitchingPostEastDeed( Serial serial ) : base( serial )
		{
		}
