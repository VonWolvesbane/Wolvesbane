...
{
	[PropertyObject]
	public abstract class DungeonRestrictionsBase<TKey> : PropertyObject
	{
		...
		public DungeonRestrictionsBase()
		{
			Invalidate();
		}

		public DungeonRestrictionsBase(GenericReader reader)
			: base(reader)
		{ }
