...
namespace VitaNex.InstanceMaps
{
	...
	public static partial class Instances
	{
		static Instances()
		{
			...
			Maps = new BinaryDirectoryDataStore<InstanceMapSerial, InstanceMap>(
				VitaNexCore.SavesDirectory + "/InstanceMaps",
				"Maps",
				"bin")
			{
			...
			Dungeons = new BinaryDirectoryDataStore<DungeonSerial, Dungeon>(
				VitaNexCore.SavesDirectory + "/InstanceMaps",
				"Dungeons",
				"bin")
			{
			...
			var instances =
				DungeonTypes.Select(t => t.CreateInstanceSafe<Dungeon>())
