	...
	public class SBFarmHand : SBInfo 
	{
		...
		{ 
			...
			{ 
                ...
                Add(new GenericBuyInfo("a corn seed", typeof(CornSeed), 75, 20, 0xF27, 0x5E2));
                Add(new GenericBuyInfo("a bloodmoss seed", typeof(BloodMossSeed), 550, 20, 0xF27, 0x5E2));
                Add(new GenericBuyInfo("a garlic seed", typeof(GarlicSeed), 550, 20, 0xF27, 0x5E2));
                Add(new GenericBuyInfo("a ginseng seed", typeof(GinsengSeed), 550, 20, 0xF27, 0x5E2));
                Add(new GenericBuyInfo("a mandrake seed", typeof(MandrakeSeed), 550, 20, 0xF27, 0x5E2));
                Add(new GenericBuyInfo("a nightshade seed", typeof(NightShadeSeed), 550, 20, 0xF27, 0x5E2));
            } 
		} 
