			...
			else
			{
				...
				if ( amountRelay != null )
				{
					...
					if ( amount > 0 )
					{
						...
						else if ( info.ButtonID == (int)BUTTONS.GOLD_CHECK && amount <= 10000000 && amount <= backpack.GoldAmount )
						{
							backpack.GoldAmount -= amount;
						...
						else if ( info.ButtonID == (int)BUTTONS.TOKENS_CHECK && amount <= 10000000 && amount <= backpack.TokensAmount )
						{
							backpack.TokensAmount -= amount;
