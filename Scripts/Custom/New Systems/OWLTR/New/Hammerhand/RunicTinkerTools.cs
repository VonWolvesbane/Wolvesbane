...
namespace Server.Items
{
	...
	public class PlatinumRunicTinkerTools : RunicTinkerTools
	{
		...
		public class WolvesbanianRunicTinkerTools : RunicTinkerTools
		{
			public override CraftSystem CraftSystem { get { return DefTinkering.CraftSystem; } }
			[Constructable]
			public WolvesbanianRunicTinkerTools()
				: base(CraftResource.Wolvesbanian)
			{
				Name = "Wolvesbanian Runic Tinker's Tools";
			}
			public WolvesbanianRunicTinkerTools(Serial serial) : base(serial) { }
