...
{
	public class ArmorOfBowFletching : BaseArmor
	{
		...
		[Constructable]
		public ArmorOfBowFletching( int bonus, int itemID, int skill ) : base( itemID )
		{
			i_SkillBonus = bonus;
			i_Skill = skill;
			...
			{
            sn_SkillName = SkillName.Fletching; 
        ...
        public ArmorOfBowFletching(Serial serial)
            : base(serial)
		{
		}
