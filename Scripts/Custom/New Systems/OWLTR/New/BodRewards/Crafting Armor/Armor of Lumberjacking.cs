...
{
	public class ArmorOfLumberjacking : BaseArmor
	{
		...
		[Constructable]
		public ArmorOfLumberjacking( int bonus, int itemID, int skill ) : base( itemID )
		{
			i_SkillBonus = bonus;
			i_Skill = skill;
			...
			{
                sn_SkillName = SkillName.Lumberjacking; 
        ...
        public ArmorOfLumberjacking(Serial serial)
            : base(serial)
		{
		}
