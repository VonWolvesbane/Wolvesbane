...
{
	public class ArmorOfCarpentry : BaseArmor
	{
		...
		[Constructable]
		public ArmorOfCarpentry( int bonus, int itemID, int skill ) : base( itemID )
		{
			i_SkillBonus = bonus;
			i_Skill = skill;
			...
			{
            sn_SkillName = SkillName.Carpentry; 
        ...
        public ArmorOfCarpentry(Serial serial)
            : base(serial)
		{
		}
