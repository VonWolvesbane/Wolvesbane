...
{
	public class ArmorOfSmithing : BaseArmor
	{
		...
		[Constructable]
		public ArmorOfSmithing( int bonus, int itemID, int skill ) : base( itemID )
		{
			i_SkillBonus = bonus;
			i_Skill = skill;
			...
			{
                sn_SkillName = SkillName.Blacksmith; 
        ...
        public ArmorOfSmithing(Serial serial)
            : base(serial)
		{
		}
