...
namespace Server.Items
{
	...
	public class PlatinumGranite : BaseGranite
	{
		...
		public class WolvesbanianGranite : BaseGranite
		{
			[Constructable]
			public WolvesbanianGranite()
				: base(CraftResource.Wolvesbanian)
			{
				Name = "Wolvesbanian Granite"; //daat99 OWLTR - granite name
			}

			public WolvesbanianGranite(Serial serial)
				: base(serial)
			{
			}
