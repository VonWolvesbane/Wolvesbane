...
namespace Server.Items
{
				...
				case 0:
					{
						...
						switch (reader.ReadInt())
						{
							...
							case 14: info = OreInfo.Wolvesbanian; break;
	...
	public class PlatinumIngot : BaseIngot
	{
		...
		[FlipableAttribute(0x1BF2, 0x1BEF)]
		public class WolvesbanianIngot : BaseIngot
		{
			[Constructable]
			public WolvesbanianIngot()
				: this(1)
			{
			}

			[Constructable]
			public WolvesbanianIngot(int amount)
				: base(CraftResource.Wolvesbanian, amount)
			{
				Name = "Wolvesbanian Ingots"; //daat99 OWLTR - resource name
			}

			public WolvesbanianIngot(Serial serial)
				: base(serial)
			{
			}
