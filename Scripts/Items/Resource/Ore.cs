...
namespace Server.Items
{
	public abstract class BaseOre : Item
	{
		...
		public override int LabelNumber
		{
			get
			{
				if (m_Resource >= CraftResource.DullCopper && m_Resource <= CraftResource.Wolvesbanian)
			...
			protected override void OnTarget(Mobile from, object targeted)
			{
				...
				if (IsForge(targeted))
				{
					...
					switch (m_Ore.Resource)
					{
						...
						case CraftResource.Wolvesbanian: difficulty = 139.0; break;
	...
	public class WolvesbanianOre : BaseOre
	{
		[Constructable]
		public WolvesbanianOre()
			: this(1)
		{
		}

		[Constructable]
		public WolvesbanianOre(int amount)
			: base(CraftResource.Wolvesbanian, amount)
		{
			Name = "Wolvesbanian Ore"; //daat99 OWLTR - custom resource name
		}

		public WolvesbanianOre(Serial serial)
			: base(serial)
		{
		}
