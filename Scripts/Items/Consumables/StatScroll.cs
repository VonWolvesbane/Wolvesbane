...
namespace Server.Items
{
    ...
    {
        private int m_StatCap = Config.Get("PlayerCaps.TotalStatCap", 1000);
        ...
        public override int Title 
        {
            get
            {
                ...
                if (level >= 0 && level <= 4 && Value % 5 == 0)
                    return 1049458 + level;	/* Wonderous Scroll (+50 Maximum Stats): OR
                * Exalted Scroll (+100 Maximum Stats): OR
                * Mythical Scroll (+150 Maximum Stats): OR
                * Legendary Scroll (+200 Maximum Stats): OR
                * Ultimate Scroll (+250 Maximum Stats): */
