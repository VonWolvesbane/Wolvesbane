		...
		private static readonly SpeedInfo[] m_Speeds =
		{
			...
			new SpeedInfo(
				...
				new[]
				{
					...
					typeof(DeepSeaSerpent), typeof(DireWolf), typeof(Dog), typeof(Dolphin), typeof(Dragon),
					...
					typeof(FireSteed), typeof(FrostSpider), typeof(Gargoyle),
					...
					typeof(RidableLlama), typeof(Scorpion), typeof(SeaSerpent), typeof(SerpentineDragon),
