...
namespace Server.Mobiles
{
	...
	public class RainbowRidgeback : BaseMount
	{
        ...
        [Constructable]
		public RainbowRidgeback() : this( "a rainbow ridgeback" )
		{
		}

		[Constructable]
		public RainbowRidgeback( string name ) : base( name, 0xE2, 0x3EA0, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public RainbowRidgeback( Serial serial ) : base( serial )
		{
		}
