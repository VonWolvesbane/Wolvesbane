...
namespace Server.Mobiles
{
	...
	public class RainbowForestOstard : BaseMount
	{
        ...
        [Constructable]
		public RainbowForestOstard() : this( "a rainbow forest ostard" )
		{
		}

		[Constructable]
		public RainbowForestOstard( string name ) : base( name, 0xE2, 0x3EA0, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public RainbowForestOstard( Serial serial ) : base( serial )
		{
		}
