...
namespace Server.Mobiles
{
	...
	public class RainbowSavageRidgeback : BaseMount
	{
        ...
        [Constructable]
		public RainbowSavageRidgeback() : this( "a rainbow savage ridgeback" )
		{
		}

		[Constructable]
		public RainbowSavageRidgeback( string name ) : base( name, 0xE2, 0x3EA0, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public RainbowSavageRidgeback( Serial serial ) : base( serial )
		{
		}
