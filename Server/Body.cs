...
namespace Server
{
	...
	public struct Body
	{
		...
		public bool IsAnimal { get { return m_BodyID == 1526 || m_BodyID == 1401 || m_BodyID == 1546 || m_BodyID == 1547 || m_BodyID == 1548 || m_BodyID == 1549 || m_BodyID == 1550 || m_BodyID == 1551 || m_BodyID == 1552 || m_BodyID == 1441 || m_BodyID == 1407 || m_BodyID == 1434 || m_BodyID == 0x5A0 || m_BodyID >= 0 && m_BodyID < m_Types.Length && m_Types[m_BodyID] == BodyType.Animal; } }
